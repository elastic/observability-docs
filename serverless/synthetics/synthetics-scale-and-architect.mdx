...
If we don't provide a UI for your exact needs, you can use <DocLink id="serverlessObservabilityDashboards">dashboards</DocLink> to build custom visualizations.
