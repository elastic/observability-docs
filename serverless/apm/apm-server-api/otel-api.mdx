...
<DocCallOut title="Tip">
  See our <DocLink id="serverlessObservabilityApmAgentsOtelNativeSupport" text="OpenTelemetry docs" /> to learn how to send data to the managed intake service from an OpenTelemetry agent OpenTelemetry collector.
</DocCallOut>