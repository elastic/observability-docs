...
{/* TODO: The above image is from classic. Replace with serverless when available. */}
...
{/* TODO: Figure out how to sync this with obs guide screenshots that are auto generated. */}
...
{/* TODO: Replace this with a screenshot that shows what we want to highlight in this section. */}
