...
1. Create a module to start the APM agent. For example, a file at the root of your repository named "initapm.js":
    ...
    ```
    [^1]: Optional {/* <DocLink id="enApmAgentNodejsConfiguration">configuration options</DocLink> */} can be added here.
...
The APM agent can be {/* <DocLink id="enApmAgentNodejsConfiguringTheAgent">configured</DocLink> */} with options to the
...
your terminal, or in the "local.settings.json" file. See the {/* <DocLink id="enApmAgentNodejsConfiguration">agent configuration guide</DocLink> */} for full details on supported
