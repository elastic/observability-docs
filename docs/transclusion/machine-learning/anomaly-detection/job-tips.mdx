...
import Buckets from './ml-buckets/buckets.mdx'
import Influencers from './ml-influencers/influencers.mdx'
...
[create ((anomaly-jobs)) API](((ref))/ml-put-job.html).

{/* TBD: Add a diagram of datafeeds, jobs, detectors, etc? */}

<div id="ml-ad-bucket-span"></div>

### Bucket span

<Buckets />

The bucket span must contain a valid [time interval](((time-units))). When you
...
If your job does not contain a  detector or the detector does not contain a 
 <DocBadge><DocIcon size="s" type="unlink" title="missing link"/> missing link</DocBadge>{/* <DocLink id="enMachineLearningMlFunctions">valid function</DocLink> */}, you receive an error. If a job contains
...
<div id="ml-ad-influencers"></div>

### Influencers

<Influencers />

<div id="ml-ad-cardinality"></div>
...
<div id="ml-ad-model-memory-limits"></div>
...
<div id="ml-ad-dedicated-indices"></div>
...
`results_index_name` via the [Create ((anomaly-jobs)) API](((ref))/ml-put-job.html).