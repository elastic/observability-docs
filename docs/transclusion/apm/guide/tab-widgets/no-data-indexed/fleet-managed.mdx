...
see <DocLink id="serverlessObservabilityApmTroubleshooting" section="common-response-codes">managed intake service response codes</DocLink> to narrow down the possible causes.
