...
* <DocLink id="serverlessObservabilityApmDataSecurity" section="create-an-ingest-pipeline-filter">Create an ingest pipeline filter</DocLink> — An APM-specific tutorial where you learn how to obfuscate passwords stored in the `http.request.body.original` field.
