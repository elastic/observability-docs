...
{/* Ref include::{apm_aws_lambda_root}/docs/images/images.asciidoc[tag=java-env-vars] not in include config. */}
{/* include::{apm_aws_lambda_root}/docs/images/images.asciidoc[tag=java-env-vars] */}
