...
1. {/* <DocLink id="enApmAgentJavaPublicApi">Public API</DocLink> */}
    A simple and stable API that is most native to the agent.
    Contains annotations to declaratively create spans.

1. {/* <DocLink id="enApmAgentJavaOpentelemetryBridge">OpenTelemetry bridge</DocLink> */}
...
1. {/* <DocLink id="enApmAgentJavaOpentracingBridge">OpenTracing bridge</DocLink> */}
    A vendor neutral API that is discontinued in favor of OpenTelemetry.

A further option is the {/* <DocLink id="enApmAgentJavaPluginApi">plugin api</DocLink> */} which uses the OpenTelemetry API and allows you to add in custom instrumentation without modifying the application.
...
Noop 
    ...
    Manual instrumentation 
        ...
        disable the auto instrumentation setting the configuration option {/* <DocLink id="enApmAgentJavaConfigCore" section="instrument-added[100changing-this-value-at-runtime-is-possible-since-version-1150]">`instrument`</DocLink> */} to `false`.
