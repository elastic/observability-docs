...
slug: /serverless/observability/monitor-application-performance-apm-send-traces-to-elastic-go-api
title: API
...
For a more in-depth example, see {/* <DocLink id="enApmAgentGoLogCorrelationIds" section="manual-log-correlation-unstructured">Manual log correlation (unstructured)</DocLink> */}.
...
<DocLink id="serverlessObservabilityApmAgentsGoApi" section="func-error-settransactiontransaction">SetTransaction</DocLink> or {/* <DocLink id="enApmAgentGoApi" section="func-error-setspanspan">SetSpan</DocLink> */}, respectively.
