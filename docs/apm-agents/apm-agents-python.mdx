...
More detailed information on how the Agent works can be found in the <DocBadge><DocIcon size="s" type="unlink" title="missing link"/> missing link</DocBadge>{/*  <DocLink id="enApmAgentPythonHowTheAgentWorks">advanced topics</DocLink> */}.
