...
import Snippet1 from '../transclusion/apm/guide/open-telemetry/otel-get-started.mdx'
...
To unlock the full power of the Elastic, use the OpenTelemetry API/SDKs with Elastic APM agents,
