...
`CRITICAL` is a valid option, but it is mapped to `ERROR`; `WARN` and `WARNING` are equivalent; 
...
<div id="config-log-ecs-reformatting"></div>

### `log_ecs_reformatting` (<DocBadgeAdded tipContent="Added in 1.22.0">1.22.0</DocBadgeAdded> experimental)
...
<DocCallOut title="Note">
while `SHADE` and `REPLACE` options are only relevant to file log appenders, the `OVERRIDE` option 
...
<div id="config-log-ecs-reformatting-additional-fields"></div>

### `log_ecs_reformatting_additional_fields` (<DocBadgeAdded tipContent="Added in 1.26.0">1.26.0</DocBadgeAdded>)
...
<div id="config-log-ecs-formatter-allow-list"></div>
...
<div id="config-log-ecs-reformatting-dir"></div>
...
<div id="config-log-file-size"></div>

### `log_file_size` (<DocBadgeAdded tipContent="Added in 1.17.0">1.17.0</DocBadgeAdded>)
...
<div id="config-log-format-sout"></div>

### `log_format_sout` (<DocBadgeAdded tipContent="Added in 1.17.0">1.17.0</DocBadgeAdded>)
...
<div id="config-log-format-file"></div>

### `log_format_file` (<DocBadgeAdded tipContent="Added in 1.17.0">1.17.0</DocBadgeAdded>)
...
<div id="config-log-sending"></div>

### `log_sending` (<DocBadgeAdded tipContent="Added in 1.36.0">1.36.0</DocBadgeAdded> experimental)
