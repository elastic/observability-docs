...
<div id="config-dedot-custom-metrics"></div>

### `dedot_custom_metrics` (<DocBadgeAdded tipContent="Added in 1.22.0">1.22.0</DocBadgeAdded>)

Replaces dots with underscores in the metric names for Micrometer metrics.

<DocCallOut title="Warning" color="warning">
Setting this to `false` can lead to mapping conflicts as dots indicate nesting in Elasticsearch.
...
<div id="config-custom-metrics-histogram-boundaries"></div>

### `custom_metrics_histogram_boundaries` (<DocBadgeAdded tipContent="Added in 1.37.0">1.37.0</DocBadgeAdded> experimental)
...
<div id="config-metric-set-limit"></div>

### `metric_set_limit` (<DocBadgeAdded tipContent="Added in 1.33.0">1.33.0</DocBadgeAdded>)
...
<div id="config-agent-reporter-health-metrics"></div>

### `agent_reporter_health_metrics` (<DocBadgeAdded tipContent="Added in 1.35.0">1.35.0</DocBadgeAdded> experimental)
...
<div id="config-agent-background-overhead-metrics"></div>

### `agent_background_overhead_metrics` (<DocBadgeAdded tipContent="Added in 1.35.0">1.35.0</DocBadgeAdded> experimental)
