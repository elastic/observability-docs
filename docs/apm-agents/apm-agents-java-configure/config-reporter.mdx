...
<DocCallOut title="Note">
This configuration is specific to the Java agent and does not align with any other APM agent. In order 
...
<div id="config-max-queue-size"></div>
...
### `metrics_interval` (<DocBadgeAdded tipContent="Added in 1.3.0">1.3.0</DocBadgeAdded>)
...
### `disable_metrics` (<DocBadgeAdded tipContent="Added in 1.3.0">1.3.0</DocBadgeAdded>)
