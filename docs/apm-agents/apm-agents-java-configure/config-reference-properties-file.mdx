...
<div id="config-reference-properties-file"></div>
...
## <DocLink id="serverlessObservabilityApmAgentsJavaConfigure" section="recording-added[1150]">`recording`</DocLink> configuration option has been set to `false`, thus reducing resource consumption to a minimum. 
...
## 
## NOTE: If this option and <DocLink id="serverlessObservabilityApmAgentsJavaConfigure" section="span_min_duration-added[1160]">`span_min_duration`</DocLink> are both configured,
...
## 
## NOTE: Disabling `tracecontext` headers injection means that [distributed tracing](((apm-guide-ref))/apm-distributed-tracing.html) 
...
## into [ECS-compatible JSON](((ecs-logging-ref))/intro.html), suitable for ingestion into Elasticsearch for 
...
## See also <DocLink id="serverlessObservabilityApmAgentsJavaConfigure" section="log_ecs_formatter_allow_list">`log_ecs_formatter_allow_list`</DocLink>.
## To properly ingest and parse ECS JSON logs, follow the [getting started guide](((ecs-logging-java-ref))/setup.html#setup-step-2).
## 
## Available options:
## 
...
##    shade logs can be configured through the <DocLink id="serverlessObservabilityApmAgentsJavaConfigure" section="log_ecs_reformatting_dir">`log_ecs_reformatting_dir`</DocLink> 
##    configuration. Shade logs do not inherit file-rollover strategy from the original logs. Instead, they 
##    use their own size-based rollover strategy according to the <DocLink id="serverlessObservabilityApmAgentsJavaConfigure" section="log_file_size-added[1170]">`log_file_size`</DocLink> 
...
##  Only relevant if <DocLink id="serverlessObservabilityApmAgentsJavaConfigure" section="log_ecs_reformatting-added[1220]-experimental">`log_ecs_reformatting`</DocLink> is set to any option other than `OFF`.
...
## <DocLink id="serverlessObservabilityApmAgentsJavaConfigure" section="log_ecs_reformatting-added[1220]-experimental">`log_ecs_reformatting`</DocLink> is set to any option other than `OFF`. 
...
## If <DocLink id="serverlessObservabilityApmAgentsJavaConfigure" section="log_ecs_reformatting-added[1220]-experimental">`log_ecs_reformatting`</DocLink> is set to `SHADE` or `REPLACE`, 
...
## See also <DocLink id="serverlessObservabilityApmAgentsJavaConfigure" section="log_ecs_reformatting-added[1220]-experimental">`log_ecs_reformatting`</DocLink>.
...
## <DocLink id="serverlessObservabilityApmAgentsJavaGetStarted">SSL/TLS communication with APM Server</DocLink>.
## 
...
## to use a cross-agent config, use <DocLink id="serverlessObservabilityApmAgentsJavaConfigure" section="server_url">`server_url`</DocLink> instead, which is the recommended option regardless if you 
