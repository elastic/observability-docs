...
<div id="config-enable-jaxrs-annotation-inheritance"></div>
...
<div id="config-use-jaxrs-path-as-transaction-name"></div>

### `use_jaxrs_path_as_transaction_name` (<DocBadgeAdded tipContent="Added in 1.8.0">1.8.0</DocBadgeAdded>)
