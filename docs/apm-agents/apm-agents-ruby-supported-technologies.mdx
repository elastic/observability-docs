...
slug: /serverless/observability/apm-agents-ruby-supported-technologies
...
See <DocLink id="serverlessObservabilityApmAgentsRubyGetStarted">Getting started with Rails</DocLink>.
...
See <DocLink id="serverlessObservabilityApmAgentsRubyGetStarted" section="grape-example">Grape example</DocLink>.
