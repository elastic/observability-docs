...
See <DocLink id="serverlessObservabilityApmAgentsPhpApi" section="transactioninterface-greatergetid">`TransactionInterface->getId`</DocLink> and <DocLink id="serverlessObservabilityApmAgentsPhpApi" section="spaninterface-greatergetid">`SpanInterface->getId`</DocLink>.
...
from the corresponding instance of <DocLink id="serverlessObservabilityApmAgentsPhpApi" section="spaninterface">SpanInterface</DocLink> or <DocLink id="serverlessObservabilityApmAgentsPhpApi" section="transactioninterface">TransactionInterface</DocLink>
