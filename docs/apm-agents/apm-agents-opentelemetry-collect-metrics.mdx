...
TSVB is the recommended visualization for OpenTelemetry metrics. TSVB is a time series data visualizer that allows you to use the
...
{/* To do: Find and add this image or remove it */}
...
<Feedback slug="/serverless/observability/apm-agents-opentelemetry-collect-metrics" filepath="docs/apm-agents/apm-agents-opentelemetry-collect-metrics.mdx" />
