...
<div id="configuration-on-asp-net"></div>
...
<div id="asp-net-sample-config"></div>
...
Once implemented, you can use the <DocLink id="serverlessObservabilityApmAgentsNetConfigure" section="fullframeworkconfigurationreadertype">`FullFrameworkConfigurationReaderType`</DocLink> setting.

<div id="config-full-framework-configuration-reader-type"></div>
