...
please view this documentation at [elastic.co](https://www.elastic.co/guide/en/apm/agent/nodejs/current/custom-spans.html)
</DocCallOut>
...
see the <DocLink id="serverlessObservabilityApmAgentsNodejsApi">Span API documentation</DocLink>.
...
1. Parse JSON sent by the client
