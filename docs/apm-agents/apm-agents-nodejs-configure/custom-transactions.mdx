...
<div id="custom-transactions"></div>
...
please view this documentation at [elastic.co](https://www.elastic.co/guide/en/apm/agent/nodejs/current/custom-transactions.html)
</DocCallOut>
...
see the <DocLink id="serverlessObservabilityApmAgentsNodejsApi">Transaction API documentation</DocLink>.
