...
<div id="opentracing"></div>

The Elastic APM Go agent provides an implementation of the [OpenTracing API](https://opentracing.io),
...
to report spans to Elastic APM. Please refer to [opentracing-go](https://github.com/opentracing/opentracing-go)
...
<div id="opentracing-mixed"></div>

### Mixing Native and OpenTracing APIs

When you import `apmot`, transactions and spans created with the <DocLink id="serverlessObservabilityApmAgentsGoApi">native API</DocLink>
...
<div id="opentracing-apm-tags"></div>
