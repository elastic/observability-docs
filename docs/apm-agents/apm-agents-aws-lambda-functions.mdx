...
<DocCallOut color="warning" title="Important">
  ...
  Read more about API keys in <DocLink id="serverlessObservabilityApmKeepDataSecure" />.
</DocCallOut>


<Feedback slug="/serverless/observability/apm-agents-aws-lambda-functions" filepath="docs/apm-agents/apm-agents-aws-lambda-functions.mdx" />
