...
<div id="install-the-agent"></div>

There are multiple ways to add the APM RUM Agent to your web page:

* <DocLink id="serverlessObservabilityApmAgentsRumGetStarted" section="using-script-tags">Using Script Tags</DocLink>: Add a `<script>` tag to the HTML page.
* <DocLink id="serverlessObservabilityApmAgentsRumGetStarted" section="using-bundlers">Using Bundlers</DocLink>: Bundling the Agent package during the application's build process

<div id="using-script-tags"></div>
...
Please download the latest version of RUM agent from [GitHub](https://github.com/elastic/apm-agent-rum-js/releases/latest) or
...
in the [cache-control](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Cache-Control)
