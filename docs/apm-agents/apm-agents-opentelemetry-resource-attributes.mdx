...
<div id="open-telemetry-resource-attributes"></div>
...
Use the [resource processor]({ot_resource}) to set or apply changes to resource attributes.
...
Attributes can be added as a part of the OpenTelemetry instrumentation process or with the [attributes processor]({ot_attr}).
