...
<Feedback slug="/serverless/observability/apm-agents-opentelemetry-resource-attributes" filepath="docs/apm-agents/apm-agents-opentelemetry-resource-attributes.mdx" />
