...
If you need to create your own custom transactions, see <DocBadge><DocIcon size="s" type="unlink" title="missing link"/> missing link</DocBadge>{/*  <DocLink id="enApmAgentAndroidManualInstrumentation">manual instrumentation</DocLink> */}.
