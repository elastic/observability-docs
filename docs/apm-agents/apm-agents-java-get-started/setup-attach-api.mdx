...
<div id="setup-attach-api-supported-environments"></div>
...
<div id="setup-attach-api-caveats"></div>
...
See the default value description of the <DocLink id="serverlessObservabilityApmAgentsJavaConfigure" section="service_name">`service_name`</DocLink> configuration option for ways to have different `service.name`s for each deployment.
...
<div id="setup-attach-api-usage"></div>
...
<p id="myapplicationjava"><strong>MyApplication.java</strong></p>
...
<div id="setup-attach-api-configuration"></div>
