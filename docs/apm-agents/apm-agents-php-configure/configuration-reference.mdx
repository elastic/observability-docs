...
<DocLink id="serverlessObservabilityApmAgentsPhpConfigure" section="api_key">`api_key`</DocLink> is an alternative to <DocLink id="serverlessObservabilityApmAgentsPhpConfigure" section="secret_token">`secret_token`</DocLink>.
If both <DocLink id="serverlessObservabilityApmAgentsPhpConfigure" section="secret_token">`secret_token`</DocLink> and <DocLink id="serverlessObservabilityApmAgentsPhpConfigure" section="api_key">`api_key`</DocLink> are configured,
then <DocLink id="serverlessObservabilityApmAgentsPhpConfigure" section="api_key">`api_key`</DocLink> has precedence and <DocLink id="serverlessObservabilityApmAgentsPhpConfigure" section="secret_token">`secret_token`</DocLink> is ignored.
...
<DocLink id="serverlessObservabilityApmAgentsPhpConfigure" section="secret_token">`secret_token`</DocLink> is an alternative to <DocLink id="serverlessObservabilityApmAgentsPhpConfigure" section="api_key">`api_key`</DocLink>.
If both <DocLink id="serverlessObservabilityApmAgentsPhpConfigure" section="secret_token">`secret_token`</DocLink> and <DocLink id="serverlessObservabilityApmAgentsPhpConfigure" section="api_key">`api_key`</DocLink> are configured
then <DocLink id="serverlessObservabilityApmAgentsPhpConfigure" section="api_key">`api_key`</DocLink> has precedence and <DocLink id="serverlessObservabilityApmAgentsPhpConfigure" section="secret_token">`secret_token`</DocLink> is ignored.
...
(automatically discovered or manually configured using <DocLink id="serverlessObservabilityApmAgentsPhpConfigure" section="hostname">`hostname`</DocLink>).
