...
slug: /serverless/observability/apm-agents-ruby-performance-tuning
...
<DocLink id="serverlessObservabilityApmAgentsRubyConfigure" section="capture_headers">`capture_headers`</DocLink> and <DocLink id="serverlessObservabilityApmAgentsRubyConfigure" section="capture_body">`capture_body`</DocLink>.
