...
import EnsureParentIdSnippet from '../../transclusion/apm/agent/nodejs/transaction-api/ensure-parent-id-snippet.mdx'
...
you need to call <DocLink id="serverlessObservabilityApmAgentsNodejsApi" section="apmstarttransaction[name][-type][-options]">`apm.startTransaction()`</DocLink>.
