...
supported built-in integrations. Actions are services or integrations with
third-party systems that run as background tasks when rule conditions are met.

{/* TODO: Clean up this section. It's strange that the docs link to uptime. I'm not sure/don't think the content there even makes sense for setting an SLO burn rate rule. */}
