...
For more information, see <DocBadge><DocIcon size="s" type="unlink" title="missing link"/> missing link</DocBadge>{/*  <DocLink id="enObservabilitySloBurnRateAlert">Create an SLO burn rate rule</DocLink> */}.