...
`Long Tasks` 
    ...
    Learn more about {/* <DocLink id="enApmAgentRumJsLongtasks">long task spans</DocLink> */}, and how to interpret them.
...
by creating {/* <DocLink id="enApmAgentRumJsCustomTransactions">custom transactions</DocLink> and custom spans with the <DocLink id="enApmAgentRumJsAgentApi" section="apmstartspan">span API</DocLink> */}.

<div id="frameworks"></div>

## Frameworks

The agent supports {/* <DocLink id="enApmAgentRumJsFrameworkIntegrations">integrations with certain frameworks</DocLink> */}.

To instrument custom metrics, like rendering time or mounting time of components on frameworks like React, Angular, Vue,
etc., use the {/* <DocLink id="enApmAgentRumJsCustomTransactions">custom transactions API</DocLink> */}.
