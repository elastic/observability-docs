...
If you are using {/* <DocLink id="enApmAgentRubyGettingStartedRails">Ruby on Rails</DocLink> */} this is done automatically for you.
...
If you're not using Rails, see {/* <DocLink id="enApmAgentRubyGettingStartedRack">Getting started with Rack</DocLink> */}.
...
{/* <DocLink id="enApmAgentRubyGettingStartedRack">Rack app</DocLink> */} to gracefully shut down.
