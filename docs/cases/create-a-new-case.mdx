...
<DocCallOut title="Tip">
You can also create a case from an alert or add an alert to an existing case. From the **Alerts** page, click the <DocIcon type="boxesHorizontal" title="More actions" /> icon and choose either **Add to existing case** or **Create new case**, and select or complete the details as required. 
</DocCallOut>
...
<Feedback slug="/serverless/observability/create-a-new-case" />
