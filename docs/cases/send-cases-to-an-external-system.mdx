...
have the **Cases** ((kib)) privilege as a user. For more details, refer to <DocBadge><DocIcon size="s" type="unlink" title="missing link"/> missing link</DocBadge>{/*  <DocLink id="enObservabilityGrantCasesAccess">Configure access to cases</DocLink> */}.
</DocCallOut>
...
You can also configure which connector is used for each case individually. See <DocLink id="serverlessObservabilityCreateANewCase" section="open-a-new-case">Open a new case</DocLink>.
</DocCallOut>
