...
<div id="custom-links-create"></div>
...
{/* ![Example metadata](images/custom-links/apm-example-metadata.png) */}

<div id="custom-links-filters"></div>
...
<div id="custom-links-examples"></div>

## Custom link examples

{/* Relevant documentation links */}
export let jira_query_params = "https://confluence.atlassian.com/jirakb/how-to-create-issues-using-direct-html-links-in-jira-server-159474.html"

export let github_query_params = "https://help.github.com/en/github/managing-your-work-on-github/about-automation-for-issues-and-pull-requests-with-query-parameters"

Not sure where to start with custom links?
Take a look at the examples below and customize them to your liking!

<div id="custom-links-examples-email"></div>
...
<div id="custom-links-examples-gh"></div>
...
<div style={{ backgroundColor: "#F1F4FA", width: "100%", height: "250px", textAlign: "center", paddingTop: "110px", marginBottom: "20px" }}><DocIcon type="image" title="missing image"/> missing image</div>
{/* ![Example github issue](images/custom-links/apm-create-github-issue.png) */}
...
See the [GitHub automation documentation]({github_query_params}) for a full list of supported query parameters.
...
<div style={{ backgroundColor: "#F1F4FA", width: "100%", height: "250px", textAlign: "center", paddingTop: "110px", marginBottom: "20px" }}><DocIcon type="image" title="missing image"/> missing image</div>
{/* ![Example jira issue](images/custom-links/apm-create-jira-issue.png) */}
...
See the [Jira application administration knowledge base]({jira_query_params})
for a full list of supported query parameters.

<div id="custom-links-examples-kib"></div>
...
<div id="custom-links-examples-slack"></div>
...
<div id="custom-links-examples-web"></div>
