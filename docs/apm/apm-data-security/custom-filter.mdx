...
{/* * Go: https://www.elastic.co/guide/en/apm/agent/go/${variables['apm-go-branch']}/[] */}
{/* * Java: https://www.elastic.co/guide/en/apm/agent/java/${variables['apm-java-branch']}/[] */}
* .NET: [Filter API](https://www.elastic.co/guide/en/apm/agent/dotnet/${variables['apm-dotnet-branch']}/public-api.html#filter-api).
* Node.js: [`addFilter()`](https://www.elastic.co/guide/en/apm/agent/nodejs/${variables['apm-node-branch']}/agent-api.html#apm-add-filter).
    {/* * PHP: https://www.elastic.co/guide/en/apm/agent/php/${variables['apm-php-branch']}[] */}

* Python: [custom processors](https://www.elastic.co/guide/en/apm/agent/python/${variables['apm-py-branch']}/sanitizing-data.html).
* Ruby: [`add_filter()`](https://www.elastic.co/guide/en/apm/agent/ruby/${variables['apm-ruby-branch']}/api.html#api-agent-add-filter).
