...
![Dependencies view in the APM app in Kibana](images/dependencies/dependencies.png)
...
![Dependencies drilldown view in the APM app in Kibana](images/dependencies/dependencies-drilldown.png)
...
![operations view in the APM app in Kibana](images/dependencies/operations.png)
...
![operations detail view in the APM app in Kibana](images/dependencies/operations-detail.png)


<Feedback slug="/serverless/observability/apm-dependencies" filepath="docs/apm/apm-ui-dependencies.mdx" />
