...
import DataStreams from '../transclusion/apm/guide/data-streams/data-streams.mdx'
import LogsDataStreams from '../transclusion/apm/guide/data-streams/logs-data-streams.mdx'
import MetricsDataStreams from '../transclusion/apm/guide/data-streams/metrics-data-streams.mdx'
import TracesDataStreams from '../transclusion/apm/guide/data-streams/traces-data-streams.mdx'
