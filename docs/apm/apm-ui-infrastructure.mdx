...
![Example view of the Infrastructure tab in APM app in Kibana](images/infrastructure/infra.png)
...
<Feedback slug="/serverless/observability/apm-infrastructure" filepath="docs/apm/apm-ui-infrastructure.mdx" />
