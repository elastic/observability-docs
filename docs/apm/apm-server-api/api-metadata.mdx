...
{/* import V2Metadata from './transclusion/spec/v2/metadata.json' */}
...
* <DocLink id="serverlessObservabilityApmServerApi" section="kubernetes-data">Kubernetes data</DocLink>
* <DocLink id="serverlessObservabilityApmServerApi" section="metadata-schema">Metadata Schema</DocLink>

<div id="api-kubernetes-data"></div>
...
<div id="api-metadata-schema"></div>

### Metadata Schema

APM Server uses JSON Schema to validate requests. The specification for metadata is defined on
[GitHub]({book['github_repo_link']}/docs/spec/v2/metadata.json) and included below:

{/* <DocCode language="json">
  {JSON.stringify(V2Metadata, null, 2)}
</DocCode> */}