...
For <DocBadge><DocIcon size="s" type="unlink" title="missing link"/> missing link</DocBadge>{/*  <DocLink id="enApmGuideApmRum">RUM</DocLink> */} send an `HTTP POST` request to the APM Server `intake/v3/rum/events` endpoint instead:
...
* <DocLink id="serverlessObservabilityApmServerApi">Metadata</DocLink>
* <DocLink id="serverlessObservabilityApmServerApi">Transactions</DocLink>
* <DocLink id="serverlessObservabilityApmServerApi">Spans</DocLink>
* <DocLink id="serverlessObservabilityApmServerApi">Errors</DocLink>
* <DocLink id="serverlessObservabilityApmServerApi">Metrics</DocLink>
* <DocBadge><DocIcon size="s" type="unlink" title="missing link"/> missing link</DocBadge>{/*  <DocLink id="enApmGuideApiEventExample">Example request body</DocLink> */}
