...
import Snippet1 from '../transclusion/observability/application-logs/correlate-logs.mdx'
import Snippet2 from '../transclusion/observability/application-logs/plaintext-logs.mdx'
import Snippet3 from '../transclusion/observability/application-logs/ecs-logging-logs.mdx'
import Snippet4 from '../transclusion/observability/application-logs/log-reformatting.mdx'
import Snippet5 from '../transclusion/observability/application-logs/apm-agent-log-sending.mdx'
