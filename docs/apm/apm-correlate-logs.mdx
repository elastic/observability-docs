...
- <DocLink id="serverlessObservabilityApmCorrelateLogs" section="how-to-ingest-application-logs">log ingestion</DocLink>: the tool you use to send and write logs to your Observability project.
...
For example, the same example shown above might look like this when structured with ECS-compatible JSON:
...
<Feedback slug="/serverless/observability/apm-correlate-logs" />
