...
description: Compress similar or identical spans to reduce storage overhead, processing power needed, and clutter in the APM UI.
...
<Feedback slug="/serverless/observability/apm-compress-spans" filepath="docs/apm/apm-compress-spans.mdx" />
