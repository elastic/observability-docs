...
![Example view of transactions annotation in the APM app in Kibana](images/annotations/apm-transaction-annotation.png)
...
<Feedback slug="/serverless/observability/apm-track-deployments-with-annotations" filepath="docs/apm/apm-track-deployments-with-annotations.mdx" />
