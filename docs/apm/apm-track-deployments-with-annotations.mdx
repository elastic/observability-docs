...
<div id="transactions-annotations"></div>
...
{/* ![Example view of transactions annotation in the APM app in Kibana](images/transactions-annotations/apm-apm-transaction-annotation.png) */}
...
See the <DocLink id="serverlessObservabilityApmKibanaApi">annotation API</DocLink> reference for more information.
