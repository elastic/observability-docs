...
![Example view of the Metrics overview in APM app in Kibana](images/metrics/apm-metrics.png)
...
<Feedback slug="/serverless/observability/apm-metrics" filepath="docs/apm/apm-ui-metrics.mdx" />
