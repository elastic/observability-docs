...
![Example view of a span detail in the APM app in Kibana](images/spans/apm-span-detail.png)
...
![Example of distributed trace colors in the APM app in Kibana](images/spans/apm-services-trace.png)
...
<Feedback slug="/serverless/observability/apm-trace-sample-timeline" filepath="docs/apm/apm-ui-trace-sample-timeline.mdx" />
