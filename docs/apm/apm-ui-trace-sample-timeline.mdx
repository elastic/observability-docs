...
{/* ![Example of distributed trace colors in the APM app in Kibana](images/spans/apm-apm-transaction-sample.png) */}
...
<div style={{ backgroundColor: "#F1F4FA", width: "100%", height: "250px", textAlign: "center", paddingTop: "110px", marginBottom: "20px" }}><DocIcon type="image" title="missing image"/> missing image</div>
{/* ![Example view of a span detail in the APM app in Kibana](images/spans/apm-apm-span-detail.png) */}

<div id="trace-sample-investigate"></div>
...
* the selected transaction in <DocBadge><DocIcon size="s" type="unlink" title="missing link"/> missing link</DocBadge>{/*  <DocLink id="enKibanaDiscover">Discover</DocLink> */}
...
<div style={{ backgroundColor: "#F1F4FA", width: "100%", height: "250px", textAlign: "center", paddingTop: "110px", marginBottom: "20px" }}><DocIcon type="image" title="missing image"/> missing image</div>
{/* ![Example of distributed trace colors in the APM app in Kibana](images/spans/apm-apm-services-trace.png) */}
...
<div style={{ backgroundColor: "#F1F4FA", width: "100%", height: "250px", textAlign: "center", paddingTop: "110px", marginBottom: "20px" }}><DocIcon type="image" title="missing image"/> missing image</div>
{/* ![Example view of the distributed tracing in APM app in Kibana](images/spans/apm-apm-distributed-tracing.png) */}
