...
You can adjust Application settings to fine-tune your experience in the APM UI.
...
<Feedback slug="/serverless/observability/apm-kibana-settings" filepath="docs/apm/apm-kibana-settings.mdx" />
