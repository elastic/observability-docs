...
The user accessing this endpoint requires `All` Kibana privileges for the {book['beat_kib_app']} feature.
...
The user accessing this endpoint requires `Read` or `All` Kibana privileges for the {book['beat_kib_app']} feature.
For more information, see <DocBadge><DocIcon size="s" type="unlink" title="missing link"/> missing link</DocBadge>{/*  <DocLink id="enKibanaKibanaPrivileges">((kib)) privileges</DocLink> */}.
