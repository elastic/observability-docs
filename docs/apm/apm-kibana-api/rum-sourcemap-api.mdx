...
<div id="limit-sourcemap-api"></div>
...
with the <DocBadge><DocIcon size="s" type="unlink" title="missing link"/> missing link</DocBadge>{/*  <DocLink id="enKibanaSettings" section="server-maxPayload">`server.maxPayload`</DocLink> */} variable.
