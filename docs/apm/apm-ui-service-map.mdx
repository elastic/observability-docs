...
From here, select **Service Details**, or click the **Transactions** tab to jump to the Transaction overview
for the selected service.
You can also use the tabs at the top of the page to easily jump to the **Errors** or **Metrics** overview.

![Example view of service maps in the APM app in Kibana](images/service-maps/service-maps-java.png)
...
To learn how to create a machine learning job, refer to <DocLink id="serverlessObservabilityApmIntegrateWithMachineLearning" />.
...
<Feedback slug="/serverless/observability/apm-service-map" filepath="docs/apm/apm-ui-service-map.mdx" />
