...
<DocCallOut title="Note">
  OpenTelemetry does not offer consistent probability samplers in all languanges. Refer to the documentation of your favorite OpenTelemetry agent or SDK for more information.
</DocCallOut>
