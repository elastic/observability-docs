...
![Example view of transactions table in the APM app in Kibana](images/transactions/apm-transactions-overview.png)
...
![Example view of the transactions table in the APM app in Kibana](images/transactions/apm-transactions-table.png)
...
![APM lattency correlations](images/transactions/correlations-hover.png)


<Feedback slug="/serverless/observability/apm-transactions" filepath="docs/apm/apm-ui-transactions.mdx" />
