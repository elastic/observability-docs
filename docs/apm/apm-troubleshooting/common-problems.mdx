...
{/* import TabWidgetsNoDataIndexedWidget from './transclusion/tab-widgets/no-data-indexed-widget.mdx' */}
{/* import GettingStartedApmServerInstallApmIntegration from './transclusion/getting-started-apm-server/install-apm-integration.mdx' */}
...
<div id="common-ssl-problems"></div>

### Common SSL-related problems

* <DocLink id="serverlessObservabilityApmTroubleshooting" section="ssl-client-fails-to-connect">SSL client fails to connect</DocLink>
* <DocLink id="serverlessObservabilityApmTroubleshooting" section="x509-cannot-validate-certificate-for-\lessip-addressgreater-because-it-doesnt-contain-any-ip-sans">x509: cannot validate certificate</DocLink>
* <DocLink id="serverlessObservabilityApmTroubleshooting" section="getsockopt-no-route-to-host">getsockopt: no route to host</DocLink>
* <DocLink id="serverlessObservabilityApmTroubleshooting" section="getsockopt-connection-refused">getsockopt: connection refused</DocLink>
* <DocLink id="serverlessObservabilityApmTroubleshooting" section="no-connection-could-be-made-because-the-target-machine-actively-refused-it">No connection could be made because the target machine actively refused it</DocLink>

<div id="ssl-client-fails"></div>
...
<div id="cannot-validate-certificate"></div>
...
The APM Server timeout can be configured by updating the
 <DocBadge><DocIcon size="s" type="unlink" title="missing link"/> missing link</DocBadge>{/* <DocLink id="enApmGuideConfigurationProcess" section="read-timeout">maximum duration for reading an entire request</DocLink> */}.
