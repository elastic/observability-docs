...
like [JVM metrics](((apm-java-ref-v))/metrics.html) in the Java Agent,
and [Go runtime](((apm-go-ref-v))/metrics.html) metrics in the Go Agent.
...
* [Go](((apm-go-ref-v))/metrics.html)
* [Java](((apm-java-ref-v))/metrics.html)
* [Node.js](((apm-node-ref-v))/metrics.html)
* [Python](((apm-py-ref-v))/metrics.html)
* [Ruby](((apm-ruby-ref-v))/metrics.html)
