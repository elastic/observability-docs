...
like [JVM metrics]({book['apm-java-ref-v']}/metrics.html) in the Java Agent,
and [Go runtime]({book['apm-go-ref-v']}/metrics.html) metrics in the Go Agent.
...
* [Go]({book['apm-go-ref-v']}/metrics.html)
* [Java]({book['apm-java-ref-v']}/metrics.html)
* [Node.js]({book['apm-node-ref-v']}/metrics.html)
* [Python]({book['apm-py-ref-v']}/metrics.html)
* [Ruby]({book['apm-ruby-ref-v']}/metrics.html)
