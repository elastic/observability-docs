...
import DataStreamsMetricsDataStreams from '../../transclusion/apm/guide/data-streams/metrics-data-streams.mdx'
import ElasticsearchMetricset from '../../transclusion/apm/guide/data/elasticsearch/metricset.mdx'
