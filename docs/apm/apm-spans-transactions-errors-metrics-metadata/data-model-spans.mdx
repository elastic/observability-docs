...
* Go: [`ELASTIC_APM_TRANSACTION_MAX_SPANS`]({book['apm-go-ref-v']}/configuration.html#config-transaction-max-spans)
* iOS: _Not yet supported_
* Java: [`transaction_max_spans`]({book['apm-java-ref-v']}/config-core.html#config-transaction-max-spans)
* .NET: [`TransactionMaxSpans`]({book['apm-dotnet-ref-v']}/config-core.html#config-transaction-max-spans)
* Node.js: [`transactionMaxSpans`]({book['apm-node-ref-v']}/configuration.html#transaction-max-spans)
* PHP: [`transaction_max_spans`]({book['apm-php-ref-v']}/configuration-reference.html#config-transaction-max-spans)
* Python: [`transaction_max_spans`]({book['apm-py-ref-v']}/configuration.html#config-transaction-max-spans)
* Ruby: [`transaction_max_spans`]({book['apm-ruby-ref-v']}/configuration.html#config-transaction-max-spans)
