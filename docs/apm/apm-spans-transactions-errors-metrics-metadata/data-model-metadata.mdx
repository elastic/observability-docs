...
* Go: [`SetLabel`]({book['apm-go-ref-v']}/api.html#context-set-label)
* Java: [`setLabel`]({book['apm-java-ref-v']}/public-api.html#api-transaction-add-tag)
* .NET: [`Labels`]({book['apm-dotnet-ref-v']}/public-api.html#api-transaction-tags)
* Node.js: [`setLabel`]({book['apm-node-ref-v']}/agent-api.html#apm-set-label) | [`addLabels`]({book['apm-node-ref-v']}/agent-api.html#apm-add-labels)
...
* Python: [`elasticapm.label()`]({book['apm-py-ref-v']}/api.html#api-label)
* Ruby:  [`set_label`]({book['apm-ruby-ref-v']}/api.html#api-agent-set-label)
* Rum: [`addLabels`]({book['apm-rum-ref-v']}/agent-api.html#apm-add-labels)
...
* Go: [`SetCustom`]({book['apm-go-ref-v']}/api.html#context-set-custom)
* iOS: _coming soon_
* Java: [`addCustomContext`]({book['apm-java-ref-v']}/public-api.html#api-transaction-add-custom-context)
* .NET: _coming soon_
* Node.js: [`setCustomContext`]({book['apm-node-ref-v']}/agent-api.html#apm-set-custom-context)
* PHP: _coming soon_
* Python: [`set_custom_context`]({book['apm-py-ref-v']}/api.html#api-set-custom-context)
* Ruby: [`set_custom_context`]({book['apm-ruby-ref-v']}/api.html#api-agent-set-custom-context)
* Rum: [`setCustomContext`]({book['apm-rum-ref-v']}/agent-api.html#apm-set-custom-context)
...
* Go: [`SetUsername`]({book['apm-go-ref-v']}/api.html#context-set-username) | [`SetUserID`]({book['apm-go-ref-v']}/api.html#context-set-user-id) |
    [`SetUserEmail`]({book['apm-go-ref-v']}/api.html#context-set-user-email)

* iOS: _coming soon_
* Java: [`setUser`]({book['apm-java-ref-v']}/public-api.html#api-transaction-set-user)
* .NET _coming soon_
* Node.js: [`setUserContext`]({book['apm-node-ref-v']}/agent-api.html#apm-set-user-context)
* PHP: _coming soon_
* Python: [`set_user_context`]({book['apm-py-ref-v']}/api.html#api-set-user-context)
* Ruby: [`set_user`]({book['apm-ruby-ref-v']}/api.html#api-agent-set-user)
* Rum: [`setUserContext`]({book['apm-rum-ref-v']}/agent-api.html#apm-set-user-context)
