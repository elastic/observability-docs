...
* Service Maps will display a color-coded anomaly indicator based on the detected anomaly score.
    ...
    ![Example view of anomaly scores on service maps in the APM app](images/service-maps/service-map-anomaly.png)
...
<Feedback slug="/serverless/observability/apm-integrate-with-machine-learning" filepath="docs/apm/apm-integrate-with-machine-learning.mdx" />
