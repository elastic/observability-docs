...
A `trace` is a group of <DocLink id="serverlessObservabilityApmDataTypes">transactions</DocLink> and <DocLink id="serverlessObservabilityApmDataTypes">spans</DocLink> with a common root.
...
<Feedback slug="/serverless/observability/apm-distributed-tracing" filepath="docs/apm/apm-distributed-tracing.mdx" />
