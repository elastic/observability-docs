...
{/* import TabWidgetsDistributedTraceSendWidget from './transclusion/tab-widgets/distributed-trace-send-widget.mdx' */}
{/* import TabWidgetsDistributedTraceReceiveWidget from './transclusion/tab-widgets/distributed-trace-receive-widget.mdx' */}
