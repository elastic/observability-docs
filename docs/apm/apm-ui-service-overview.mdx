...
The expected bounds comparison is powered by <DocLink id="serverlessObservabilityApmIntegrateWithMachineLearning">machine learning</DocLink> and requires anomaly detection to be enabled.
...
<Feedback slug="/serverless/observability/apm-service-overview" filepath="docs/apm/apm-ui-service-overview.mdx" />
