...
import Snippet1 from '../transclusion/kibana/apm/service-overview/throughput-transactions.mdx'
import Snippet2 from '../transclusion/kibana/apm/service-overview/ftr.mdx'
import Snippet3 from '../transclusion/kibana/apm/service-overview/dependencies.mdx'
