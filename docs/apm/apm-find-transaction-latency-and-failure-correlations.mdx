...
Queries within the ((apm-app)) are also applied to the correlations.
</DocCallOut>

<div id="correlations-latency"></div>
...
{/* ![Latency correlations](images/correlations/apm-correlations-hover.png) */}
...
<div style={{ backgroundColor: "#F1F4FA", width: "100%", height: "250px", textAlign: "center", paddingTop: "110px", marginBottom: "20px" }}><DocIcon type="image" title="missing image"/> missing image</div>
{/* ![Failed transaction correlations](images/correlations/apm-correlations-failed-transactions.png) */}
