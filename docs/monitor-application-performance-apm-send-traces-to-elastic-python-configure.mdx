...
Note: Do not set this if you are using APM in an AWS lambda function. APM Agents are designed to proxy their calls to the APM Server through the lambda extension. Instead, set `ELASTIC_APM_LAMBDA_APM_SERVER`. For more info, see {/* <DocLink id="enApmAgentPythonLambdaSupport">AWS Lambda</DocLink> */}.
...
See {/* <DocLink id="enApmAgentPythonSanitizingData">sanitizing data</DocLink> */} for more information on how to filter out sensitive data.
</DocCallOut>
...
For more information, see {/* <DocLink id="enApmAgentPythonSanitizingData">Sanitizing Data</DocLink> */}.
...
See {/* <DocLink id="enApmAgentPythonMetrics" section="prometheus-metric-set-beta">Prometheus metric set (beta)</DocLink> */} for more information.
...
See {/* <DocLink id="enApmAgentPythonMetrics" section="custom-metrics">Custom Metrics</DocLink> */} for more information.
...
By default in python 3, the agent installs a {/* <DocLink id="enApmAgentPythonLogs" section="logging">LogRecord factory</DocLink> */} that
