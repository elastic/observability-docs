...
1. From the **Actions** menu in the **Anomalies** table, select **Configure job rules**.
        ...
        {/* TODO: Question: Is there some other place where job rules can be configured? this step requires an anomaly to exist before a rule can be created. */}
...
refer to the [Machine Learning](((ml-docs))/ml-configuring-url.html#ml-configuring-url-strings) documentation.
