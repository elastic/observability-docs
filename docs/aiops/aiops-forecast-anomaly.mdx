...
you can use the machine learning features to predict future behavior.
...
1. (Optional) Specify when the forecast expires. By default, it expires in 14 days and is deleted automatically thereafter.
1. Click **Run**.
...
1. (Optional) After the job has processed more data, click the **Forecast** button again to compare the forecast to actual data.
        ...
        This combination of actual and forecast data gives you an indication of how well the machine learning features can extrapolate the future behavior of the data.

import Feedback from '../partials/feedback/widget.mdx'

<Feedback slug="/serverless/observability/aiops" filepath="docs/aiops/aiops-forecast-anomaly.mdx" />
