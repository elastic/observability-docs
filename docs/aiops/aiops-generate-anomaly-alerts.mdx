...
description: Generate alerts when anomalies match specific conditions.
...
<DocCallOut title="Note">
    Anomaly detection alert rules are defined as part of a job.
    Alerts generated by these rules do not appear on the **Alerts** page.
</DocCallOut>

{/*  TODO: Need input from reviewers, is this ^ expected behavior? */}
