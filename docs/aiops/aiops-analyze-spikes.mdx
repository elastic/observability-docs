...
1. From the **Actions** menu in the table, you can choose to inspect a field in **Discover**,
further, <DocLink id="serverlessObservabilityAiopsAnalyzeSpikes" section="log-pattern-analysis" text="investigate in Log pattern analysis" />, or copy the table row information to the clipboard as a query filter.
...
1. From the **Actions** menu, chooose **Log pattern analysis**.
