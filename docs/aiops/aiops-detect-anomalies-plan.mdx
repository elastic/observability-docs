...
<div id="ml-ad-plan"></div>

The ((ml-features)) in ((stack)) enable you to seek anomalies in your data in many
different ways. Using <DocBadge><DocIcon size="s" type="unlink" title="missing link"/> missing link</DocBadge>{/*  <DocLink id="enMachineLearningMlAdAlgorithms">proprietary ((ml)) algorithms</DocLink> */}, the
...
For the full list of functions that you can use in your ((anomaly-jobs)), see
 <DocBadge><DocIcon size="s" type="unlink" title="missing link"/> missing link</DocBadge>{/* <DocLink id="enMachineLearningMlFunctions">Function reference</DocLink> */}. For a list of the preconfigured jobs, see <DocBadge><DocIcon size="s" type="unlink" title="missing link"/> missing link</DocBadge>{/*  <DocLink id="enMachineLearningOotbMlJobs">Supplied ((anomaly-detect)) configurations</DocLink> */}. 
