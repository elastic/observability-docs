...
framework integrations like {/* <DocLink id="enApmAgentPythonDjangoSupport">Django</DocLink> and <DocLink id="enApmAgentPythonFlaskSupport">Flask</DocLink> */}
...
they have to be set beforehand by calling <DocLink id="serverlessObservabilityApmAgentsPythonApi" section="elasticapmset_transaction_name">`elasticapm.set_transaction_name()`</DocLink> and {/* <DocLink id="enApmAgentPythonApi" section="elasticapmset_transaction_result">`elasticapm.set_transaction_result()`</DocLink> */} during the transaction.
</DocCallOut>
