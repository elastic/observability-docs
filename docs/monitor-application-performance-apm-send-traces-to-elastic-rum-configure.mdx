...
To understand the different types, see {/* <DocLink id="enApmAgentRumJsBreakdownMetricsDocs">Breakdown Metrics</DocLink> */}
</DocCallOut>
...
inferred by the agent based on the current URL. Check the {/* <DocLink id="enApmAgentRumJsCustomTransactionName">custom initial page load transaction names</DocLink> */}
...
HTTP header to the configured origins. Before enabling this flag, make sure to change your {/* <DocLink id="enApmAgentRumJsDistributedTracingGuide" section="server-configuration">server configuration</DocLink> */} to avoid
...
responsiveness. Learn more about {/* <DocLink id="enApmAgentRumJsLongtasks">long task spans</DocLink> */} and how to interpret them.
...
{/* <DocLink id="enApmAgentRumJsConfiguringCors">configure Cross-Origin Resource Sharing (CORS)</DocLink> */}.
</DocCallOut>
