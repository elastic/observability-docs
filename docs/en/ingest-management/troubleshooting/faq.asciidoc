...
[source,console]
----
POST kbn:api/fleet/epm/packages/[package name]/[package version] <1>
{ "force": true }
----

<1> When using the Dev Tools Console, prepend requests to Kibana API endpoints
with `kbn:`.
...
[source,console]
----
POST kbn:api/fleet/epm/packages/system/1.0.0
{ "force": true }
----
