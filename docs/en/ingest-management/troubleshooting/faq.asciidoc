...
//REVIEWERS: Is the following statement still true? It was supposed to be
//fixed after 7.14. I've copied the statement directly into this document
//so you can review it and decide whether to remove or include it going forward.
