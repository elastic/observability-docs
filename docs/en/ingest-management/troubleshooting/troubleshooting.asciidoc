...
In Elastic Cloud on scaling up or down the hosted {agent}, new containers for the Elastic Agent are started and the old ones are shut down. The old Elastic Agents will show up in the list for 24 hours and will automatically disappear afterwards.
