...
****
**Reviewers:** Is there any reason why we don't link to the topic about
Elastic Agent environment variables like we do in the K8s topic? In fact, in the
K8s topic, we include some of the setting descriptions under "configuration details"
What should we do in this topic? Just include a link?
****
