...
To learn more about how you can leverage these variables for autodiscovery refer to
<<elastic-agent-kubernetes-autodiscovery,kubernetes autodiscovery with Elastic Agent>> for more information
