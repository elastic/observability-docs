...
------------------------------------------------
curl -L -O https://raw.githubusercontent.com/elastic/elastic-agent/{branch}/deploy/kubernetes/elastic-agent-standalone/elastic-agent-standalone-daemonset.yaml
------------------------------------------------
...
["source", "sh", subs="attributes"]
------------------------------------------------
kubectl create -f elastic-agent-standalone-daemonset.yaml
------------------------------------------------
...
in the `elastic-agent-standalone-daemonset.yaml` manifest. Container resource usage depends on the number of datastreams
