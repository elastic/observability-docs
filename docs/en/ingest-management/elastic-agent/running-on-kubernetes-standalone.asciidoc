...
include::configuration/env/shared-env.asciidoc[tag=elasticsearch-username]

include::configuration/env/shared-env.asciidoc[tag=elasticsearch-password]

include::configuration/env/shared-env.asciidoc[tag=elasticsearch-host]
...
tolerations to run on master nodes. These tolerations collect metrics from the control plane
