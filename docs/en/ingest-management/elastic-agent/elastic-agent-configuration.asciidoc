...
//TODO: Revisit the includes here after merging
// https://github.com/elastic/observability-docs/pull/424. We probably want
//to interleave metrics and log settings so that they appear together. Including
//in one file right now to build/test the additions.

include::configuration/inputs/input-metrics-configuration.asciidoc[]
