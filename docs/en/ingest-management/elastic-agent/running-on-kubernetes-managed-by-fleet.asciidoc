...
In more details:
- <<create-a-policy>> and 
- <<add-integration>> to learn how to configure the https://docs.elastic.co/en/integrations/kubernetes[Kubernetes integration].
...
Find more information for [Enrollment Tokens](https://www.elastic.co/guide/en/fleet/current/fleet-enrollment-tokens.html)
