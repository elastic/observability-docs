...
------------------------------------------------
curl -L -O https://raw.githubusercontent.com/elastic/elastic-agent/{branch}/deploy/kubernetes/elastic-agent-managed/elastic-agent-managed-daemonset.yaml
------------------------------------------------
...
["source", "sh", subs="attributes"]
------------------------------------------------
kubectl create -f elastic-agent-managed-daemonset.yaml
------------------------------------------------
...
in the `elastic-agent-managed-daemonset.yaml` manifest. Container resource usage depends on the number of datastreams
