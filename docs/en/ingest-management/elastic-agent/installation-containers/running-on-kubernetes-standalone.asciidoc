...
include::deploy-kube-state-metrics.asciidoc[]

include::download-elastic-agent.asciidoc[]
...
- name: ES_HOST
  value: "https://somesuperhostiduuid.europe-west1.gcp.cloud.es.io:443" <3>
------------------------------------------------
...
include::agent-tolerations.asciidoc[]


:manifest: elastic-agent-standalone-kubernetes.yaml
include::deploy-elastic-agent.asciidoc[]

[discrete]
== View your data in {kib}

. Launch {kib}:
+
--
include::{shared-path}/open-kibana/widget.asciidoc[]
--
