...
Elastic Agent is a single binary designed to provide the same functionality that the various Beats provide today. However, there are some current functionality gaps that are continuously being addressed as we strive to reach feature parity.
