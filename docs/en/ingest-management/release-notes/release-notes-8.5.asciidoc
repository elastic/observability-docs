...
* Unable to add Fleet Server integration and fleet server policies are created without fleet server integration [https://github.com/elastic/kibana/issues/144880]
Windows users please note: We discovered a high severity issue that only affects Windows users in Self Managed environments. 
(https://github.com/elastic/kibana/issues/144880) has been resolved in 8.5.2. We advise Windows users not to upgrade to the 8.5.1 release.
