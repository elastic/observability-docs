...
[[known-issue-issue-121059]]
.Bug in agent policies
[%collapsible]
====
...
New agent policies are created without the system integration, even when *Collect system logs and metrics* is selected.
