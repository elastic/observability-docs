...
NOTE: To create a *Browser* monitor, you must use the *complete* {agent} Docker container as this contains the dependencies to run browser monitors. To learn more, see {observability-guide}/synthetics-quickstart-fleet.html[Synthetic monitoring via {agent} and {fleet}].
