...
//QUESTION: Is this section still true? It does appear that we get a better error now,
//plus it seems that users are overlooking this section. Should I keep this section or remove it?
