...
Diagnostics bundles can be downloaded from {fleet} to be viewed locally.
...
Any in-progress or previously collected bundles for the {agent} will be listed below.
