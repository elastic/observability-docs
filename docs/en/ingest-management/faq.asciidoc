...
To reinstall the assets for a specific integration, you can use the UI for most cases
and the {fleet} API for those not allowed in the UI.
In order to use the API, you'll need to know the package name and version
