...
On macOS and Windows, {elastic-enpdoint} can protect against malicious users and
attackers when the {endpoint-cloud-sec} integration is added to the agent policy. For
