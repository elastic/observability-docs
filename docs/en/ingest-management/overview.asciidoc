...
{agent} enables numerous use cases with a single agent, simplifying data collection, endpoint-based
threat prevention and detection, and host inspection. Administrators can quickly deploy Agent across
all infrastructure. Unified policy management streamlines use case expansion.
