...
+
[role="screenshot"]
image::images/apm-fleet-prompt.png[Add APM & Fleet node prompt]
+
...
+
You now need to install and enroll your agents.
...
*Agents* tab in *{fleet}*.
+
Notice that the *Default Fleet Server policy* is
