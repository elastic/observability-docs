...
[discrete]
[[agent-policy-scale]]
== Scale of Policies Supported

Maximum number of Elastic Agent policies supported in a single {fleet} is 500. You may experience slowness in response when a higher number of policies are configured. 
