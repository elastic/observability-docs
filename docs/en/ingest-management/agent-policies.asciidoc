...
Maximum number of Elastic Agent policies supported by {fleet} is 500. You may experience slowness in response when a higher number of policies are configured. 
