...
include::elastic-agent/configuration/processors/processors.asciidoc[leveloffset=+1]
...
include::elastic-agent/configuration/elastic-agent-kubernetes-autodiscovery.asciidoc[leveloffset=+2]
