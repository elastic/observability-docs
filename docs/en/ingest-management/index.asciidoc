...
:shared-env-path: {fleet-repo-dir}/elastic-agent/configuration/env/shared-env.asciidoc

:shared-path: {observability-docs-root}/docs/en/shared
...
:y: images/green-check.svg[yes]
:n: images/red-x.svg[no]
...
include::elastic-agent/installation-containers/install-elastic-agent-in-container.asciidoc[leveloffset=+2]

include::elastic-agent/installation-containers/elastic-agent-container.asciidoc[leveloffset=+3]

include::elastic-agent/installation-containers/running-on-kubernetes-managed-by-fleet.asciidoc[leveloffset=+3]

include::elastic-agent/installation-containers/running-on-kubernetes-standalone.asciidoc[leveloffset=+3]
