...
//REVIEWERS: Is the following section true?
...
//Commented out because this reference points to beats docs.
//See <<http-endpoint>> for more information on configuration the metrics HTTP endpoint.
