...
- Regarding the `url` placeholder, this placeholder should be used to add links to the link:https://www.elastic.co/guide/index.html[Elastic documentation guides] in your documentation:
    ...
    - Example usage:
        - In the documentation files (`_dev/build/docs/*.md`) `{{ url "getting-started-observability" "Elastic guide" }}` generates a link to the Observability {observability-guide}/getting-started-observability.html[Getting started guide].
...
The setup section points the reader to the Observability {observability-guide}/getting-started-observability.html[Getting started guide]. for generic step-by-step instructions.
