...
// DK: This link doesn't work for me so I've commented it out. Can anyone suggest what it should be changed to?
...
We decided to make a few assumptions for the Cobertura classification:
