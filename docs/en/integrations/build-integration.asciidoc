...
// It should also be possible to specify a file:// reference instead of a Git reference. I haven't tested this yet, so I'm not including this here for now.
// Can we also use external references in the other files?
