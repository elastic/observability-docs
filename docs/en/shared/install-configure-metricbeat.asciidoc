...
Console without typing in any permissions) and search for `dev tools` in the {kibana-ref}/introduction.html#kibana-navigation-search[global search field].
From the **Console**, send the following request:
+
[source,console]
----
