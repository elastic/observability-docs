...
Refer to {observability-guide}/apm-configuration-rum.html#apm-apm-rum-library-pattern[Library Frame Pattern].

[discrete]
[[rum-allow-origins]]
==== Allowed Origins

Refer to {observability-guide}/apm-configuration-rum.html#apm-apm-rum-allow-origins[Allowed Origins].
