...
<<<<<<< HEAD:docs/en/apm-server/upgrading-to-8.x.asciidoc
...
>>>>>>> 38f04c90 (docs: remove false deprecation note for standalone apm-server (#3752)):docs/en/observability/apm/upgrading-to-8.x.asciidoc
