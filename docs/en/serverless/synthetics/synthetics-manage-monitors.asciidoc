[[observability-synthetics-manage-monitors]]
= Manage monitors

preview:[]

After you've <<observability-synthetics-get-started,created a synthetic monitor>>,
...
After you've <<observability-synthetics-get-started-project,set up a Synthetics project>>,
