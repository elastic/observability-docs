...
[discrete]
[[synthetics-get-started-ui-prerequisites]]
== Prerequisites
...
[discrete]
[[synthetics-get-started-ui-add-a-browser-monitor]]
...
use a <<synthetics-get-started-project,Synthetics project>> instead.
...
For more information, refer to <<synthetics-recorder,Use the Synthetics Recorder>>.
====
. Click **Advanced options** to see more ways to configure your monitor.
+
...
Read more about available options in <<synthetics-command-reference,Use the Synthetics CLI>>.
. (Optional) Click **Run test** to verify that the test is valid.
. Click **Create monitor**.

[discrete]
[[synthetics-get-started-ui-view-in-your-observability-project]]
...
[discrete]
[[synthetics-get-started-ui-next-steps]]
== Next steps
