...
* <<synthetics-monitor-use,Configure individual browser monitors>> for browser monitors
* <<synthetics-lightweight,Configure lightweight monitors>> for lightweight monitors
