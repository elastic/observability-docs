...
Get started in <DocLink id="serverlessObservabilitySyntheticsGetStartedProject">Create monitors in a Synthetics project</DocLink>.
...
Get started in <DocLink id="serverlessObservabilitySyntheticsGetStartedUi">Create monitors in the Synthetics UI</DocLink>.
