...
For more information about security-sensitive use cases, refer to <DocLink id="serverlessObservabilitySyntheticsParamsSecrets" section="synthetics-secrets-sensitive" />.
