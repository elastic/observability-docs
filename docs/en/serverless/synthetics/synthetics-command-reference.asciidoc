...
Read more in <<synthetics-params-secrets,Work with params and secrets>>.
+
...
Elastic. Allowed options are described in the <<synthetics-configuration,configuration file>>
...
Read more about what's included in a template Synthetics project in <<synthetics-get-started-project-create-a-synthetics-project,Create a Synthetics project>>.
...
[discrete]
[[synthetics-command-reference-tag-monitors]]
== Tag monitors
...
[discrete]
[[synthetics-command-reference-filter-monitors]]
== Filter monitors
