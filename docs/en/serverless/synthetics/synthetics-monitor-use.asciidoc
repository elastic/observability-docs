[[observability-synthetics-monitor-use]]
...
[NOTE]
====
This is only relevant for monitors that are created and managed using a <<observability-synthetics-get-started-synthetics-project,Synthetics project>>.
For more information on configuring browser monitors added in the UI,
refer to <<observability-synthetics-get-started-ui,Create monitors in the Synthetics UI>>.
====

After <<observability-synthetics-create-test,writing synthetic journeys>>, you can use `monitor.use`
...
or <<observability-synthetics-private-location,create a {private-location}>> to run monitors from your own premises.
...
For more details, refer to <<observability-synthetics-configuration,Configure a Synthetics project>>.
