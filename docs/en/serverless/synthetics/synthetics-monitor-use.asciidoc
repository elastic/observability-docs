...
[NOTE]
====
This is only relevant for monitors that are created and managed using a <<synthetics-get-started-synthetics-project,Synthetics project>>.
For more information on configuring browser monitors added in the UI,
refer to <<synthetics-get-started-ui,Create monitors in the Synthetics UI>>.
====
...
For more details, refer to <<synthetics-configuration,Configure a Synthetics project>>.
