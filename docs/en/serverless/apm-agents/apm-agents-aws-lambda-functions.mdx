...
The natural integration of <DocLink id="serverlessObservabilityApmDistributedTracing">distributed tracing</DocLink> into your AWS Lambda functions provides insights into each function's execution and runtime behavior as well as its relationships and dependencies to other services.
