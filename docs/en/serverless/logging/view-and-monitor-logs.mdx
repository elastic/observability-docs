...
For more on filtering your data in Logs Explorer, refer to <DocLink id="serverlessObservabilityFilterAndAggregateLogs" section="filter-logs-in-logs-explorer">Filter logs in Log Explorer</DocLink>.
