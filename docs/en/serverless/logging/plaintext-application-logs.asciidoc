...
. Set the `hosts` to your project's {es} endpoint. Locate your project's endpoint by clicking the help icon ({icon-help}) and selecting **Endpoints**. Add the **{es} endpoint** to your configuration.
