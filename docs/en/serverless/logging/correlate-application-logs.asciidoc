...
**{icon-documentation} Learn more in <<observability-plaintext-application-logs,Plaintext logs>>**
...
**{icon-documentation} Learn more in <<observability-ecs-application-logs,ECS formatted logs>>**
...
**{icon-documentation} Learn more in <<observability-send-application-logs,{apm-agent} log sending>>**
