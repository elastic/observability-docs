...
Selecting a  <<apm-services,**service**>> brings you to the **Service overview**.
...
[discrete]
[[apm-service-overview-time-series-and-expected-bounds-comparison]]
...
The expected bounds comparison is powered by <<apm-integrate-with-machine-learning,machine learning>> and requires anomaly detection to be enabled.

[discrete]
[[apm-service-overview-latency]]
== Latency
...
[discrete]
[[apm-service-overview-span-types-average-duration-and-dependencies]]
...
[discrete]
[[apm-service-overview-cold-start-rate]]
== Cold start rate
...
The cold start rate chart is currently supported for <<apm-observe-lambda-functions-cold-starts,AWS Lambda>>
functions and Azure functions.

[discrete]
[[apm-service-overview-instances]]
== Instances
...
[discrete]
[[apm-service-overview-service-metadata]]
== Service metadata
