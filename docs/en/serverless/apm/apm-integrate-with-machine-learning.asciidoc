[[apm-integrate-with-machine-learning]]
...
[discrete]
[[apm-integrate-with-machine-learning-enable-anomaly-detection]]
...
[discrete]
[[apm-integrate-with-machine-learning-anomaly-detection-warning]]
...
[discrete]
[[apm-integrate-with-machine-learning-unknown-service-health]]
...
. No machine learning job exists. See <<apm-integrate-with-machine-learning-enable-anomaly-detection,Enable anomaly detection>> to enable anomaly detection and create a machine learning job.
