...
refer to <<apm-send-data-to-elastic>>.
...
Learn more about visualizing APM data in <<apm-view-and-analyze-traces>>.

// TO DO: ADD SCREENSHOT

[TIP]
====
Not seeing any data? Find helpful tips in <<apm-troubleshooting,Troubleshooting>>.
====

[discrete]
[[apm-get-started-next-steps]]
== Next steps

Now that data is streaming into your project, take your investigation to a
deeper level. Learn how to use <<apm-view-and-analyze-traces,Elastic's built-in visualizations for APM data>>,
<<alerting,alert on APM data>>,
or <<apm-send-data-to-elastic,fine-tune how agents send traces to Elastic>>.
