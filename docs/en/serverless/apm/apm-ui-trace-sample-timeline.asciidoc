...
[discrete]
[[apm-trace-sample-timeline-investigate]]
== Investigate
...
* the <<apm-service-map,service map>> filtered by the selected trace
* the selected transaction in **Discover**
* your <<apm-create-custom-links,custom links>>

[discrete]
[[apm-trace-sample-timeline-distributed-tracing]]
== Distributed tracing
