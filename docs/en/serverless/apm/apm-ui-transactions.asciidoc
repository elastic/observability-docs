...
See <<apm-observe-lambda-functions-cold-starts,Cold starts>> for more information.

[discrete]
[[apm-transactions-transactions-table]]
== Transactions table
...
refer to the documentation for each <<apm-agents-elastic-apm-agents,APM Agent>> you've implemented.
====
...
[NOTE]
====
More information on timeline waterfalls is available in <<apm-trace-sample-timeline,spans>>.
====
...
To learn more, see <<apm-find-transaction-latency-and-failure-correlations,Find transaction latency and failure correlations>>.
