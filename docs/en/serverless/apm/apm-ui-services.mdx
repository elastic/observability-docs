...
<DocCallOut title="Tip">
   Want to monitor service logs without instrumenting all your services? Learn about our <DocLink slug="/serverless/observability/new-experience-services">new **Services** inventory experience.</DocLink>
</DocCallOut>
