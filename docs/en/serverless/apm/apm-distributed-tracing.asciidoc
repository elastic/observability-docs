...
A `trace` is a group of <<apm-data-types,transactions>> and <<apm-data-types,spans>> with a common root.
...
[discrete]
[[apm-distributed-tracing-why-is-distributed-tracing-important]]
...
[discrete]
[[apm-distributed-tracing-how-distributed-tracing-works]]
...
[discrete]
[[apm-distributed-tracing-trace-propagation-examples]]
...
[discrete]
[[apm-distributed-tracing-visualize-distributed-tracing]]
...
[discrete]
[[apm-distributed-tracing-manual-distributed-tracing]]
...
[discrete]
[[apm-distributed-tracing-add-the-traceparent-header-to-outgoing-requests]]
