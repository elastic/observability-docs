...
<DocCallOut title="Does opting into the new experience affect other users?">
   No. The settings are applied at the browser level,
   which means that other users need to opt in if they want to use the new experience.
</DocCallOut>
...
{/* TODO: Activate link after https://github.com/elastic/observability-docs/pull/4054 is merged To learn how, refer to <DocLink slug="/serverless/observability/add-logs-service-name" />.*/}
