...
[discrete]
[[observability-apm-kibana-settings-general-settings]]
== General settings
...
beta:[] When continuous rollups are enabled, the UI will select metrics with the appropriate resolution.
...
[discrete]
[[observability-apm-kibana-settings-apm-labs]]
== APM Labs
