...
1. In your ((observability)) project, go to **Inventory** to view all of your entities.
    ...
    When you open the Inventory for the first time, you need to enable the Elastic Entity Model to start using it. Once enabled, the Inventory will be accessible to anyone with the appropriate privileges.
...
### Add data
To add entities, select **Add data** from the left-hand navigation and choose one the following onboarding journeys:
