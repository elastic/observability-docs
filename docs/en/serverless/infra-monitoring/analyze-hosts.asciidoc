...
* <<analyze-hosts-the-chart-interval-is-too-short-and-data-is-missing,The chart interval is too short and data is missing>>
...
[discrete]
[[analyze-hosts-the-chart-interval-is-too-short-and-data-is-missing]]
...
[discrete]
[[analyze-hosts-i-dont-recognize-a-host-name-and-i-see-a-question-mark-icon-next-to-it]]
...
specifically `system.kubernetes.node.name` as described in <<apm-server-api,Kubernetes data>>.
