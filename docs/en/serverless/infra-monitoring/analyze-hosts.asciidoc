...
To learn more about the metrics shown on this page, refer to the <<observability-metrics-reference>> documentation.
...
<<observability-get-started-with-metrics,Get started with system metrics>>.
====
...
[TIP]
====
For more information about creating and viewing alerts, refer to <<observability-alerting>>.
====
...
* Enter a search query using {kibana-ref}/kuery-query.html[{kib} Query Language] to show metrics that match your search criteria. For example,
...
To see metrics for a specific host, refer to <<view-host-details,View host details>>.
...
To see logs for a specific host, refer to <<view-host-details,View host details>>.
...
To see alerts for a specific host, refer to <<view-host-details,View host details>>.
...
To learn more about creating and managing rules, refer to <<observability-alerting>>.
====
...
* <<dashed-interval,The chart interval is too short>>
* <<dashed-missing,Data is missing>>
* <<observability-analyze-hosts-the-chart-interval-is-too-short-and-data-is-missing,The chart interval is too short and data is missing>>
...
[discrete]
[[observability-analyze-hosts-the-chart-interval-is-too-short-and-data-is-missing]]
...
[discrete]
[[observability-analyze-hosts-troubleshooting]]
== Troubleshooting
...
[discrete]
[[observability-analyze-hosts-what-does-mean]]
=== What does _this host has been detected by APM_ mean?

// What the user sees/experiences (error message, UI, behavior, etc)

In the Hosts view, you might see a question mark icon ({icon-questionInCircle})
...
[discrete]
[[observability-analyze-hosts-i-dont-recognize-a-host-name-and-i-see-a-question-mark-icon-next-to-it]]
...
specifically `system.kubernetes.node.name` as described in <<observability-apm-server-api,Kubernetes data>>.
