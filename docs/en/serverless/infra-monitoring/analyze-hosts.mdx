...
To learn more about the metrics shown on this page, refer to the <DocLink id="serverlessObservabilityMetricsReference" /> documentation.
...
<DocCallOut title="Tip">
    For more information about creating and viewing alerts, refer to <DocLink id="serverlessObservabilityAlerting" />.
</DocCallOut>
...
To see logs for a specific host, refer to <DocLink id="serverlessObservabilityAnalyzeHosts" section="view-host-details" text="View host details" />.
...
To see alerts for a specific host, refer to <DocLink id="serverlessObservabilityAnalyzeHosts" section="view-host-details" text="View host details" />.
...
<DocCallOut title="Why are alerts missing from the Hosts page?">
    ...
    * For Inventory rules, select **Host** for the node type under **Conditions**.
    ...
    To learn more about creating and managing rules, refer to <DocLink id="serverlessObservabilityAlerting" />.
</DocCallOut>
...
* <DocLink id="serverlessObservabilityAnalyzeHosts" section="the-chart-interval-is-too-short">The chart interval is too short</DocLink>
* <DocLink id="serverlessObservabilityAnalyzeHosts" section="data-is-missing">Data is missing</DocLink>
* <DocLink id="serverlessObservabilityAnalyzeHosts" section="the-chart-interval-is-too-short-and-data-is-missing">The chart interval is too short and data is missing</DocLink>
