...
<DocTable columns={[
  ...
  <DocRow>
    ...
    <DocCell>Derivative of the maximum of `docker.network.in.bytes` scaled to a 1 second rate.
  ...
  <DocRow>
    ...
    <DocCell>Derivative of the maximum of `docker.network.out.bytes` scaled to a 1 second rate.
...
<DocTable columns={[
  ...
  <DocRow>
    ...
    <DocCell>Average count of read operations from the device per second.
  ...
  <DocRow>
    ...
    <DocCell>Average count of write operations from the device per second.
