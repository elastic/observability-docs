...
Click the more options icon ({icon-boxesVertical}) to the right of the SLO you want to add a burn rate rule for, and select **{icon-bell} Create new alert rule** from the menu.
