...
Threshold breaches occur when an ((observability)) data type reaches or exceeds the threshold set in your <DocLink id="serverlessObservabilityCreateCustomThresholdAlertRule" text="custom threshold rule" />.
