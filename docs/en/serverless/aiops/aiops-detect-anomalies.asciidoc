...
You can accept the default settings for most settings now and <<aiops-tune-anomaly-detection-job,tune the job>> later.
...
[discrete]
[[aiops-detect-anomalies-view-the-results]]
= View the results
...
To learn more, refer to <<aiops-tune-anomaly-detection-job>>
...
[discrete]
[[aiops-detect-anomalies-next-steps]]
== Next steps

After setting up an anomaly detection job, you may want to:

* <<aiops-tune-anomaly-detection-job>>
* <<aiops-forecast-anomalies>>
* <<aiops-generate-anomaly-alerts>>
