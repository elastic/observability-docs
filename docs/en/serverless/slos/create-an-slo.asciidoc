...
* **Monitor name** — The name of one or more <<synthetics-configuration,synthetic monitors>>.
* **Project** — The ID of one or more <<synthetics-configuration-project,projects>> containing synthetic monitors.
* **Tags** — One or more <<synthetics-configuration,tags>> assigned to synthetic monitors.
...
For more information about configuring the rule, see <<create-slo-burn-rate-alert-rule,Create an SLO burn rate rule>>.
