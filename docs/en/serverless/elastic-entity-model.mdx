...
You can enable the Elastic Entity Model from the new <DocLink slug="/serverless/observability/inventory">Inventory</DocLink>.

<DocCallOut color="empty|warning|danger" title="">
If already enabled, you will not be prompted to enable the Elastic Entity Model.    
</DocCallOut>
