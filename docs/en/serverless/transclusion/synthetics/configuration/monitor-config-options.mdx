...
<DocDefList>
  ...
  <DocDefDescription>
    Enable or disable monitor status alerts. Read more about alerts in <DocLink slug="/serverless/observability/synthetics-settings" section="alerting">Alerting</DocLink>.
  </DocDefDescription>
