...
| [[common-monitor-type]]**`type`** (`"http"`, `"icmp"`, or `"tcp"`)
...
| [[common-monitor-service_name]]**`service.name`**
(<<synthetics-lightweight-data-string,string>>)
...
| [[common-monitor-enabled]]**`enabled`**
...
| [[common-monitor-schedule]]**`schedule`**
...
| [[common-monitor-timeout]]**`timeout`**
(<<synthetics-lightweight-data-duration,duration>>)
...
| [[common-monitor-retest_on_failure]]**`retest_on_failure`**
(<<synthetics-lightweight-data-bool,boolean>>)
...
| [[common-monitor-locations]]**`locations`**
...
| [[common-monitor-private_locations]]**`private_locations`**
(list of <<synthetics-lightweight-data-string,string>>s)
