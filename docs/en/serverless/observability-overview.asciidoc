[[serverless-observability-overview]]
...
image::images/serverless-capabilities.svg[Elastic {observability} overview diagram]
...
<<log-monitoring,Learn more about log monitoring →>>
...
[discrete]
[[serverless-observability-overview-application-performance-monitoring-apm]]
...
<<apm,Learn more about Application performance monitoring (APM) →>>
...
<<infrastructure-monitoring,Learn more about infrastructure monitoring → >>

[discrete]
[[serverless-observability-overview-synthetic-monitoring]]
...
For more information, see <<monitor-synthetics,Synthetic monitoring>>.

[discrete]
[[serverless-observability-overview-alerting]]
== Alerting
...
<<alerting,Learn more about alerting → >>

[discrete]
[[serverless-observability-overview-service-level-objectives-slos]]
...
<<slos,Learn more about SLOs → >>

[discrete]
[[serverless-observability-overview-cases]]
== Cases
...
<<cases,Learn more about cases → >>

[discrete]
[[serverless-observability-overview-aiops]]
== AIOps
