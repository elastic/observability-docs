...
* <<monitor-status-alert-uptime>> for use with the Uptime app. status_badge::[cloud_hosted, deprecated, 8.15.0] status_badge::[cloud_serverless, unavailable]
+
[WARNING]
====
...
== Uptime monitor status status_badge::[cloud_hosted, deprecated, 8.15.0] status_badge::[cloud_serverless, unavailable]
