...
+
[role="screenshot"]
image::images/agent-tut-creating-a-queue.png[Screenshot of the queue creation window]
...
+
[role="screenshot"]
image::images/agent-tut-configure-event-notification.png[Screenshot of the event notification creation window]

. For the destination, select the SQS queue you just created.
+
[role="screenshot"]
image::images/agent-tut-configure-notification-output.png[Screenshot of event notification destination settings]
...
image::images/agent-tut-one-bucket-archi.png[Diagram of the current logging architecture for VPC flow logs]
...
image::images/agent-tut-two-buckets-archi.png[Diagram of the logging architecture with access logging enabled]
...
+
[role="screenshot"]
image::images/agent-tut-create-s3-bucket.png[Screenshot of the S3 bucket creation window]
...
+
[role="screenshot"]
image::images/agent-tut-enable-server-access-logging.png[Screenshot of server access logging properties]
