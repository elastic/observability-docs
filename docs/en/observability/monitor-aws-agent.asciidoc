...
To create the new bucket for S3 access logs:
...
//TODO: figure out why log sream contains "failed to find message" under messages
...
//TODO: Figure out why Metrics view isn't showing anything and add screenshot
