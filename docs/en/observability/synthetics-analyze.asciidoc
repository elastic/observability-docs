...
All monitors included your deployment will be listed below with information about the location,
current status, and duration average.
...
Then click an individual monitor to see more details.
...
The _Duration trends_ chart displays the timing for each check that was performed since the monitor was created.
This visualization helps you to gain insights into how quickly requests resolve by the targeted endpoint
and gives you a sense of how frequently a host or endpoint was down in your selected time span.
...
Click through each step using *image:images/icons/arrowLeft.svg[Previous icon] Previous* and
...
compared to all other runs in the last 24 hours.
...
// What info it includes
The *Object weight* and *Object count* visualization shows...
