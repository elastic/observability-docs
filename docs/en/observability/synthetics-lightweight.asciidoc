...
status_badge::[cloud_hosted, beta, 8.5.0]
...
To use the UI, go to **Synthetics** in {kib} or your serverless project to create and configure monitors.
...
To use YAML files to create lightweight monitors in a Synthetics project, <<synthetics-get-started-project,set up a project>>
