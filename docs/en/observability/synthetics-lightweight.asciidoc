...
must execute Synthetics with elevated permissions to perform ICMP pings.
...
Alternatively, one may grant ping permissions to the user Synthetics runs as. To grant ping permissions
