...
--
include::../apm-server/legacy/tab-widgets/install-agents-widget.asciidoc[]
--
...
--
include::../apm-server/legacy/tab-widgets/configure-agent-widget.asciidoc[]
--
...
--
include::../apm-server/legacy/tab-widgets/configure-server-widget.asciidoc[]
--
