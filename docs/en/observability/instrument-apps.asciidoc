...
[NOTE]
=====
If you haven’t already, please install {es} for storing and searching your data, {kib} for
...
There are many different ways to modify the Elastic ecosystem to your needs.
