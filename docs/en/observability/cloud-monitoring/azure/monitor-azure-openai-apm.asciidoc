...
To download the example application and try it for yourself, got to the https://github.com/mdbirnstiehl/AzureOpenAIAPMmonitoringOtel[GitHub repo] for the example application.
