...
Amazon Elastic Compute Cloud (Amazon EC2) enables you to provision compute
...
To collect EC2 logs and metrics, you typically need to install the Elastic
...
{agent} is currently the preferred way to add EC2 logs and metrics. For other
...
This section describes the key metrics that you should watch, organized by
category. For a full list of exported fields, refer to the
{integrations-docs}/aws/ec2[Amazon EC2 integration docs].

[discrete]
=== CPU utilization

Here are the key CPU utilization metrics you should monitor.
...
NOTE: The credit metrics shown in this table are available on burstable performance
instances only. To learn more about burstable performance instances, refer to
the
https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances.html[Amazon EC2 documentation].

****
**What to look for in CPU utilization metrics**
...
Here are the key disk I/O metrics you should monitor.
...
****
**What to look for in disk I/O metrics**
...
Here are the key network metrics you should monitor.
...
****
**What to look for in network metrics**
...
Here are the key status check metrics you should monitor.
...
****
**What to look for in status check metrics**
