...
Now you will can add monitors to your private location in the {uptime-app} or using the Elastic Synthetics libray's `push` method.Read more in <<synthetic-run-tests>>.