...
*Where monitors run (<<synthetics-migrate-integration-location,read more>>)*:
...
*How to use projects (<<synthetics-migrate-integration-projects,read more>>)*:

* *{agent} integration*:
.. Created a project that uses `@elastic/synthetics`.
...
.. Create a project that uses `@elastic/synthetics`.
...
*How to use the UI (<<synthetics-migrate-integration-ui,read{nbsp}more>>)*:

* *{agent} integration*:
.. Went to the *Integrations* page in {kib}.
