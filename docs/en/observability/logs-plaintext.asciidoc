...
* <<ingest-plaintext-logs-with-the-agent,{agent}>> A single agent for logs, metrics, security data, and threat prevention. With Fleet, you can centrally manage {agent} policies and lifecycles directly from {kib}.
