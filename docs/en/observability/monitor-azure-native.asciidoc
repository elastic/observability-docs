...
+
[role="screenshot"]
image::images/monitor-azure-native-create-elastic-resource.png[Screenshot of Elastic resource creation in Azure]
...
+
[role="screenshot"]
image::images/monitor-azure-native-elastic-deployment.png[Screenshot of deployment details for Elastic resource in Azure]
...
+
[role="screenshot"]
image::images/monitor-azure-native-elastic-config-logs-metrics.png[Screenshot of logs and metrics configuration for Elastic resource in Azure]
+
...
+
[role="screenshot"]
image::images/monitor-azure-native-kibana-observability-page-data.png[Screenshot of {kib} {observability} overview]
...
+
[role="screenshot"]
image::images/monitor-azure-native-kibana-logs-app.png[{kib} {logs-app}]
...
+
[role="screenshot"]
image::images/monitor-azure-native-elastic-vms.png[Screenshot that shows VMs selected for logs and metrics collection]
...
+
[role="screenshot"]
image::images/monitor-azure-native-kibana-vms-logs.png[Screenshot of VM logs in the {logs-app}]

. To view VM metrics, go to **Infrastructure -> Inventory** and then select a VM.
+
[role="screenshot"]
image::images/monitor-azure-native-kibana-vms-metrics.png[Screenshot of VM metrics]
+
To explore the data further, click **Open as page**. 
+
[role="screenshot"]
image::images/monitor-azure-native-kibana-vms-metrics-detail.png[Screenshot of detailed VM metrics]
