...
== Monitors stopped running after upgrading to 8.8.0 or above status_badge::[cloud_serverless, unavailable]
...
== You do not have permission to use Elastic managed locations status_badge::[cloud_serverless, unavailable]
