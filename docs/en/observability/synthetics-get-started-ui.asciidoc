...
* {ref}/security-privileges.html#privileges-list-indices[Indices privileges] for `synthetics-*`: `read`, `view_index_metadata`, `create_doc`, `auto_configure` and for `.alerts-observability.uptime.alerts-*`: `read`
======
