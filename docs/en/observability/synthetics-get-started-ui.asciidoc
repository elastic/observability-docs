...
You can create synthetic monitors directly in the Synthetics UI.
...
use <<synthetics-get-started-project,Synthetics project>> instead.
...
Navigate to the Synthetics UI, where you can see screenshots of each run,
