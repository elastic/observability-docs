...
+
Locations passed will be merged with locations defined in your
<<synthetics-configuration-monitor,`synthetics.config.js` file>> and
<<synthetics-monitor-use,when using `monitor.use`>> in individual journey files.
...
+
{private-location}s passed will be merged with {private-location}s defined in your
<<synthetics-configuration-monitor,`synthetics.config.js` file>> and
<<synthetics-monitor-use,when using `monitor.use`>> in individual journey files.
