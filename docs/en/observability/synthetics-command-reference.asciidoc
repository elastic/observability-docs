...
// If Elastic managed locations is disabled, will they see an error message? What will it say?
...
// If Elastic managed locations is disabled, will they see a list of public locations? Or an error message?
