...
IMPORTANT: When upgrading from version 8.9.x or earlier, you must remove all existing profiling data.

We still recommend upgrading, as newer versions contain improvements and new features.
