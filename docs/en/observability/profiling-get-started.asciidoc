...
. Log in to https://cloud.elastic.co[{ecloud}] and locate your deployment.
. Click the *Manage Deployment* icon next to your deployment.
...
Once enabled, Universal Profiling in {kib} is located under *Observability* in the navigation menu.
