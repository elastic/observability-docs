...
If your {ecloud} deployment originated from version 7.x or earlier and is currently running on version 8.9.0–8.10.2, you may encounter a problem while trying to enable Universal Profiling.
...
this error. In this scenario, if upgrading to 8.10.3 did not solve the issue, you need to complete the following step.
