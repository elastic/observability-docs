...
[source,bash]
----
wget https://repo1.maven.org/maven2/co/elastic/apm/elastic-apm-agent/1.18.0/elastic-apm-agent-1.18.0.jar
----
...
[source,bash]
----
java -javaagent:/path/to/elastic-apm-agent-1.18.0.jar\
...
[source,bash]
----
java -jar /path/to/apm-agent-attach-1.18.0-standalone.jar --list
----
...
[source,bash]
----
java -jar /tmp/apm-agent-attach-1.18.0-standalone.jar --pid 30730 \
