...
In this guide, you'll learn how to monitor a Java application using Elastic
...
this screenshot from the {kib} Applications UI.
...
You could now go ahead and open up the Applications UI and you should see the
data flowing in.
...
+
[role="screenshot"]
image:./images/monitor-java-app-apm-ui-javalin-app.png[Javalin App Applications UI]
+
...
+
[role="screenshot"]
image:./images/monitor-java-app-apm-ui-javalin-with-transaction-names.png[Applications UI with
