...
* Making assertions using https://playwright.dev/docs/test-assertions[`@playwright/test`'s `expect` function].
...
Elastic Synthetics uses https://playwright.dev/docs/test-assertions[`@playwright/test`'s `expect` function].
For a complete list of available assertions, refer to https://playwright.dev/docs/api/class-genericassertions#methods[the Playwright documentation].
