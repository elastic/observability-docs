...
`monitor`::     The `monitor.use` method allows you to determine a monitor's configuration on a journey-by-journey basis.
                ...
                See the "Project monitors" option in <<synthetics-get-started-project>>.
...
For more information on using `monitor`, see the "Project monitors" option in <<synthetics-get-started-project>>.
