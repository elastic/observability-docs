...
`monitor`::     The `monitor.use` method allows you to determine a monitor's configuration on a journey-by-journey basis.
                ...
                Note that this is only relevant when using the `push` command to create monitors in {kib} or your serverless project.
...
* Making assertions using:
** https://playwright.dev/docs/test-assertions[`@playwright/test`'s `expect` function] (read more in <<synthetics-make-assertions-playwright,Supported Playwright assertions>>) status_badge::[cloud_hosted, added, 8.11.0] status_badge::[synthetics_cli, added, 1.5.0]
** Elastic Synthetics's `expect` methods (read more in <<synthetics-make-assertions-jest,Supported Jest assertion>>) status_badge::[cloud_hosted, deprecated, 8.11.0] status_badge::[synthetics_cli, deprecated, 1.5.0]
...
[discrete]
[[synthetics-make-assertions-playwright]]
== Supported playwright assertions status_badge::[cloud_hosted, added, 8.11.0] status_badge::[synthetics_cli, added, 1.5.0]
...
[discrete]
[[synthetics-make-assertions-jest]]
== Supported Jest methods status_badge::[cloud_hosted, deprecated, 8.11.0] status_badge::[synthetics_cli, deprecated, 1.5.0]
