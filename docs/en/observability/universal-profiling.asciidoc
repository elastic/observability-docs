...
Hovering your mouse over a rectangle in the flamegraph displays the frame's details in the window. To see more frame information, click on the "Show Information Window" text after pinning the tooltip.
