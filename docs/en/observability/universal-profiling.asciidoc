...
To open **Universal Profiling**, find **Infrastructure** in the main menu or use the {kibana-ref}/introduction.html#kibana-navigation-search[global search field].

Under **Universal Profiling**, click **Stacktraces** to open the <<profiling-stacktraces-intro,stacktraces view>>.
...
Language ({kibana-ref}/kuery-query.html[KQL]).
