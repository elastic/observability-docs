...
[role="screenshot"]
image::./images/dependencies.png[Dependencies view in the APM UI in Kibana]
...
[role="screenshot"]
image::./images/dependencies-drilldown.png[Dependencies drilldown view in the APM UI in Kibana]
...
[role="screenshot"]
image::./images/operations.png[operations view in the APM UI in Kibana]
...
[role="screenshot"]
image::./images/operations-detail.png[operations detail view in the APM UI in Kibana]
