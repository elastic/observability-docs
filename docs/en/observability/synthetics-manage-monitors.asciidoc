...
--
include::tab-widgets/uptime-monitoring/manage-monitors-update-test-content.asciidoc[tag=managed]
--
...
--
include::tab-widgets/uptime-monitoring/manage-monitors-update-monitor-content.asciidoc[tag=managed]
--
...
--
include::tab-widgets/uptime-monitoring/manage-monitors-delete-monitor-content.asciidoc[tag=managed]
--
