...
using https://www.elastic.co/guide/en/beats/heartbeat/current/monitor-browser-options.html#monitor-source-inline[`inline`] or reference tests stored elsewhere using https://www.elastic.co/guide/en/beats/heartbeat/current/monitor-browser-options.html#monitor-source-zipurl[`zip_url`].
