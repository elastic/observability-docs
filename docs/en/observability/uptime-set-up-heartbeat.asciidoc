...
.  Once authenticated, monitors push data to **Elasticsearch**.
. **Kibana**, specifically the **Observability Uptime app**, reads results from Elasticsearch and visualizes the results.
====
