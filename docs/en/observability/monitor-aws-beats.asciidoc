...
image::images/creating-a-s3-bucket.png[S3 bucket creation]
...
=====
image::images/creating-a-queue.png[Queue Creation]
...
image::images/configure-event-notification.png[Event Notification Setting]

Set the destination as the SQS queue you just created.

image::images/configure-notification-output.png[Event Notification Setting]
...
image::images/one-bucket-archi.png[Current Architecture]
...
image::images/two-buckets-archi.png[Architecture with Access Logging Enabled]
...
image::images/Server-Access-Logging.png[Enabling Server Access Logging]
...
image::images/EC2-logs.png[EC2 logs in the Logs UI]
...
image::images/S3-Server-Access-Logs.png[S3 Server Access Log Overview]
...
image::images/EC2-instances.png[Your EC2 Infrastructure]
