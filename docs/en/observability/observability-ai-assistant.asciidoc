...
any knowledge base articles you created before 8.12 will no longer be supported.
...
You can also add external data to the knowledge base either in {kib} using the Stack Management UI or using the Index API.
