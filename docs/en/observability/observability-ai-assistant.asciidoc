...
* From *{stack-manage-app}* -> *AI Assistants* -> *Elastic AI Assistant for Observability* `Manage Settings` button.
* From the `More ations` menu inside the AI Assistant window.
+
[role="screenshot"]
image::images/obs-ai-assistant-settings-access.png[AI Assistant Settings]
