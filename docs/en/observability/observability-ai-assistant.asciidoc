...
* An {enterprise-search-ref}/server.html[Enterprise Search] server if {enterprise-search-ref}/connectors.html[Search Connectors] are used for the knowledge base.
...
* The Knowledge Base section of the obs-ai-settings[AI Assistant Settings] page.
* Search Connectors
* Using the {es} Index API.
