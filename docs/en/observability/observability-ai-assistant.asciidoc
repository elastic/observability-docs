...
[IMPORTANT]
====
In Elastic Cloud or ECE, if you have Machine Learning autoscaling enabled, Machine Learning nodes will be started when using the Knowledge Base and AI Assistant features.
Therefore, it will incur into additional costs.
====
