...
* Contextual insights that explain errors and messages and suggest remediation in the {observability} UI. 
* Chat that uses function calling to request, analyze, and visualize your data.
...
The Observability AI Assistant requires the following:
...
[discrete]
[[data-information]]
== Your data and the Observability AI Assistant
...
To use the Observability AI Assistant:
...
. From *{stack-manage-app}* -> *{connectors-ui}* in {kib}, create a {kibana-ref}/gen-ai-action-type.html[Generative AI connector]. Authenticate communication between {observability} and the AI provider by completing the following:
...
You can interact with the Observability AI Assistant through chat and contextual prompts located throughout {observability}. See the following sections for more on interacting with the AI Assistant.
...
You can find AI Assistant contextual prompts throughout {observability} that provide the following information:
