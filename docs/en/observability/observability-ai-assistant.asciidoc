...
Select the *AI Assistant* icon (image:images/icon-settings.png[Settings icon,17,17]) in the upper-right corner of any {observability} application to start the chat:
