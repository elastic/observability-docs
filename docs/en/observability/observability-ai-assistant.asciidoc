...
* *ML privilege and resources*: If you enable a rule of type NER, you must first {ml-docs}/nlp/ml-nlp-ner-example.html[deploy and start an NER model] and have sufficient ML capacity.
