...
** {enterprise-search-ref}/connectors.html[connectors]. For example, the {enterprise-search-ref}/connectors-github.html[GitHub connector] can automatically capture, sync, and index issues, markdown files, pull requests, and repositories.
