...
You can also add external data to the knowledge base through the following methods:

* The **Knowledge base** tab of the <<obs-ai-settings>> page.
* **Search Connectors**, accessible from the <<obs-ai-settings>> page.
* The **{es} Index and Reindex APIs** (requires advanced skills).
...
{enterprise-search-ref}/connectors.html[Search Connectors] enable you to index content from external sources thereby making it available for the AI Assistant. This can greatly improve the relevance of the AI Assistant’s responses.
You can manage connectors under *Search* -> *Connectors* in {kib}
...
* *Settings*: This section allows you to configure the main AI Assistant settings, which are explained directly within the interface.
* *Knowledge base*: This section allows you to <<obs-ai-kb-ui,manage knowledge base entries>>. 
