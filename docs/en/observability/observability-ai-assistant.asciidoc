...
You can also add external data to the knowledge base through:

* The **knowledge base** section of the <<obs-ai-settings>> page.
* **Search Connectors**, also linked within the <<obs-ai-settings>> page.
* Using the **{es} Index and Reindex APIs**
...
[NOTE]
====
Search Connectors require an Enterprise Search server
====
...
The AI Assistant Settings page includes the following tabs:

* Settings: where you can configure the main AI Assistant Settings (described inline).
* Knowledge base: where you can manage the different knowledge base entries. 
