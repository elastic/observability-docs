...
. To open AI Assistant settings, search for `ai assistants` in the {kibana-ref}/introduction.html#kibana-navigation-search[global search field].
...
These connectors are managed under the Search Solution in {kib}, they are outside of the {observability} Solution, and they require an {enterprise-search-ref}/server.html[Enterprise Search] server connected to the Elastic Stack.
...
. To open **Connectors**, search for `content/connectors` in the {kibana-ref}/introduction.html#kibana-navigation-search[global search field].
+
[NOTE]
====
...
* Search for `ai assistants` in the {kibana-ref}/introduction.html#kibana-navigation-search[global search field].
