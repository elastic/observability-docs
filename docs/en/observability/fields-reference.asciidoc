...
This section lists Elastic Common Schema (ECS) fields the Logs and Metrics apps use to display data.
...
populated automatically in the Logs and Metrics apps. If you cannot use {beats}, map your data to
...
include::logs-app-fields.asciidoc[]