...
. From the *Metric* dropdown, choose the metric you want to analyze (which are dependent on which report
...
(which are dependent on which report you previously selected):
