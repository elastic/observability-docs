...
{beatname_uc} collects and preprocesses system and service metrics. System metrics include information
about running processes, as well as CPU, memory, disk, and network utilization numbers.
...
Redis or MySQL. An integration consists of metricsets that fetch and structure the data. 
