...
{beatname_uc} allows you to read, preprocess, and ship data from sources that come
in the form of files. {filebeat} monitors the log files or locations that you specify,
...
{beatname_uc} uses integrations to collect and parse log data.
