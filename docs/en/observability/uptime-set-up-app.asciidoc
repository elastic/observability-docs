...
include::tab-widgets/uptime-monitoring/uptime-set-up-content.asciidoc[tag=ui]

[NOTE]
.Private locations
====
After you <<synthetics-private-location>> you'll see your new private location
in the list of _Monitor locations_. The new private location will have the
_Location name_ you provided and a "Private" badge next to its name.
