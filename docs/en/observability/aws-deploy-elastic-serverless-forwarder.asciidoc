...
- `ElasticServerlessForwarderAssumeRoles`: Add a comma delimited list of {aws} IAM Roles ARNs that the forwarder should be given permission for the `sts:AssumeRole` action (if any).
