...
- `ElasticServerlessForwarderSQSBatchSize`: Raise this value above the default (`10`) if you experience ingestion delays in your output and `ApproximateNumberOfMessagesVisible` and `ApproximateAgeOfOldestMessage` SQS CloudWatch metrics for the <<aws-serverless-forwarder-inputs-direct>> keep increasing and the average execution time of the Elastic Serverless Forwarder is below 14 minutes. This will increase the number of messages the Elastic Serverless Forwarder will process in a single execution for the <<aws-serverless-forwarder-inputs-direct>>.
- `ElasticServerlessForwarderSQSMaximumBatchingWindowInSeconds`: Raise this value above the default (`0`) if you experience ingestion delays in your output and `ApproximateNumberOfMessagesVisible` and `ApproximateAgeOfOldestMessage` SQS CloudWatch metrics for the <<aws-serverless-forwarder-inputs-direct>> keep increasing and the average execution time of the Elastic Serverless Forwarder is below 14 minutes. This will increase the number of messages the Elastic Serverless Forwarder will process in a single execution for the <<aws-serverless-forwarder-inputs-direct>>.
...
- `ElasticServerlessForwarderS3SQSMaximumBatchingWindowInSeconds`: Raise this value above the default (`0`) if you experience ingestion delays in your output and `ApproximateNumberOfMessagesVisible` and `ApproximateAgeOfOldestMessage` SQS CloudWatch metrics for the <<aws-serverless-forwarder-inputs-s3>> keep increasing and the average execution time of the Elastic Serverless Forwarder is below 14 minutes. This will increase the number of messages the Elastic Serverless Forwarder will process in a single execution for the <<aws-serverless-forwarder-inputs-s3>>.
...
- `ElasticServerlessForwarderKinesisBatchSize`: Raise this value above the default (`10`) if you experience ingestion delays in your output and `GetRecords.IteratorAgeMilliseconds` and `IncomingRecords` Kinesis CloudWatch metrics for the <<aws-serverless-forwarder-inputs-kinesis>> keep increasing and the average execution time of the Elastic Serverless Forwarder is below 14 minutes. This will increase the number of records the Elastic Serverless Forwarder will process in a single execution for the <<aws-serverless-forwarder-inputs-kinesis>>.
- `ElasticServerlessForwarderKinesisStartingPosition`: Change this value from the default (`TRIM_HORIZON`) if you want to change the starting position of the records processed by the Elastic Serverless Forwarder for the <<aws-serverless-forwarder-inputs-kinesis>>.
- `ElasticServerlessForwarderKinesisStartingPositionTimestamp`: Set this value to the time from which to start reading, in Unix time seconds, if you set `ElasticServerlessForwarderKinesisStartingPosition` to "AT_TIMESTAMP".
- `ElasticServerlessForwarderKinesisMaximumBatchingWindowInSeconds`: Raise this value above the default (`0`) if you experience ingestion delays in your output and `GetRecords.IteratorAgeMilliseconds` and `IncomingRecords` Kinesis CloudWatch metrics for the <<aws-serverless-forwarder-inputs-kinesis>> keep increasing and the average execution time of the Elastic Serverless Forwarder is below 14 minutes. This will increase the number of records the Elastic Serverless Forwarder will process in a single execution for the <<aws-serverless-forwarder-inputs-kinesis>>.
- `ElasticServerlessForwarderKinesisParallelizationFactor`: Raise this value above the default (`1`) if you experience ingestion delays in your output and `GetRecords.IteratorAgeMilliseconds` and `IncomingRecords` Kinesis CloudWatch metrics for the <<aws-serverless-forwarder-inputs-kinesis>> keep increasing, the average execution time of the Elastic Serverless Forwarder is below 14 minutes and you unbalanced partitions in your <<aws-serverless-forwarder-inputs-kinesis>>. This will increase the number of records the Elastic Serverless Forwarder will increase the number of parallel execution for the <<aws-serverless-forwarder-inputs-kinesis>>.
    ...
    Resources:
      SarCloudformationDeployment:
        ...
        Properties:
          ...
          Parameters:
            ElasticServerlessForwarderS3ConfigFile: ""
            ElasticServerlessForwarderContinuingQueueBatchSize: 10
            ElasticServerlessForwarderContinuingMaximumBatchingWindowInSeconds: 0
            ElasticServerlessForwarderSSMSecrets: ""
            ElasticServerlessForwarderKMSKeys: ""
            ElasticServerlessForwarderSQSEvents: ""
            ElasticServerlessForwarderSQSBatchSize: 10
            ElasticServerlessForwarderSQSMaximumBatchingWindowInSeconds: 0
            ElasticServerlessForwarderS3SQSEvents: ""
            ElasticServerlessForwarderS3SQSBatchSize: 10
            ElasticServerlessForwarderS3SQSMaximumBatchingWindowInSeconds: 0
            ElasticServerlessForwarderKinesisEvents: ""
            ElasticServerlessForwarderKinesisBatchSize: 10
            ElasticServerlessForwarderKinesisStartingPosition: "TRIM_HORIZON"
            ElasticServerlessForwarderKinesisStartingPositionTimestamp: 0
            ElasticServerlessForwarderKinesisMaximumBatchingWindowInSeconds: 0
            ElasticServerlessForwarderKinesisParallelizationFactor: 1
            ElasticServerlessForwarderCloudWatchLogsEvents: ""
            ElasticServerlessForwarderS3Buckets: ""
            ElasticServerlessForwarderSecurityGroups: ""
            ElasticServerlessForwarderSubnets: ""
