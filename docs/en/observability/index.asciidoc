...
// Group: Start here
include::start-here.asciidoc[leveloffset=+1]
...
// Quickstarts
//include::quickstarts/quickstarts-overview.asciidoc[leveloffset=+3]

include::quickstarts/monitor-hosts-with-elastic-agent.asciidoc[leveloffset=+3]

include::quickstarts/monitor-k8s-logs-metrics.asciidoc[leveloffset=+3]

//TODO: Delete this file when we're sure we don't want to keep it
//include::traces-get-started.asciidoc[leveloffset=+3]
...
include::exploratory-data-visualizations.asciidoc[leveloffset=+3]

include::inspect.asciidoc[leveloffset=+3]
...
include::monitor-infra/monitor-infrastructure-and-hosts.asciidoc[leveloffset=+1]
