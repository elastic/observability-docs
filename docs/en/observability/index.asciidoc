...
include::quick-start-logs-metrics-uptime.asciidoc[leveloffset=+2]

include::quick-start-traces.asciidoc[leveloffset=+2]
...
include::synthetics-quickstart-fleet.asciidoc[leveloffset=+2]
