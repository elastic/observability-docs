...
// Group: Hosts and infrastructure
...
// Group: Data insights
include::data-insights.asciidoc[leveloffset=+1]

//Observability AI Assistant
include::observability-ai-assistant.asciidoc[leveloffset=+2]
...
include::monitor-java-app.asciidoc[leveloffset=+2]
