...
include::synthetics-lightweight-common.asciidoc[leveloffset=+3]
include::synthetics-lightweight-http.asciidoc[leveloffset=+3]
include::synthetics-lightweight-tcp.asciidoc[leveloffset=+3]
include::synthetics-lightweight-icmp.asciidoc[leveloffset=+3]
include::synthetics-lightweight-data-types.asciidoc[leveloffset=+3]
