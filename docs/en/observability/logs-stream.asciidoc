...
After creating your ingest pipeline, you need to index your log data to a data stream using an index template. The following command creates an index template:
