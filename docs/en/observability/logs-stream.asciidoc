...
- `data_stream.namespace: web-frontend` shows data streams with a namespace of `web-frontend`

The following example shows the search results for logs with a dataset of `apm.error` and a namespace of `default`:
