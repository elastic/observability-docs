...
NOTE: After installing the {agent}, the `elastic-agent.yml` file is copied to the directory described in the {fleet-guide}/installation-layout.html[installation layout].
