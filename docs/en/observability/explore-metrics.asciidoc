...
`system.network.name` field. You will also need to add the *Series Agg* aggregation, along with the `sum` function.
+
8. If you would like to save this visualization and add it to a custom dashboard at a later time, click *Save*.
