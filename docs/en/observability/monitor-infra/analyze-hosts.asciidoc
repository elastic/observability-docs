...
[discrete]
==== A dashed line may indicate the chart interval is too short
...
[discrete]
==== A dashed line may indicate missing data
...
[discrete]
==== A dashed line may indicate the chart interval is too short and there is missing data
