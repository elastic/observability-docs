...
//REVIEWERS: Lising all the source fields here feels like it could incur a lot
//of maintenance over time. Do we want to keep this level of detail? This sort
//of runs contrary to our goal to document all the metrics in one place, though.
//If we keep this, I should probably link to the metrics reference for a description
//of any metrics-related fields. WDYT?
