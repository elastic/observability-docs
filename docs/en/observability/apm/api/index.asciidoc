...
[cols="1,1"]
|===
| https://www.elastic.co/docs/api/doc/observability-serverless[Managed intake service API] image:images/icons/popout.svg[] status_badge::[cloud_hosted, unavailable]
a|  The managed intake service exposes an API endpoint to query general server information.
...
| <<apm-app-api>> status_badge::[cloud_serverless, unavailable]
...
| <<apm-api>> status_badge::[cloud_serverless, unavailable]
