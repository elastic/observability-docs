...
=== Upstream OpenTelemetry SDKs and Collectors

++++
<titleabbrev>Upstream OpenTelemetry SDKs and Collectors</titleabbrev>
++++
...
*To compare approaches and choose the best approach for your use case, refer to <<apm-open-telemetry,several approaches>>.*
====
...
* Send data to the {stack} from an <<apm-connect-open-telemetry-collector,OpenTelemetry collector>>
* Send data to the {stack} from an <<apm-instrument-apps-otel,OpenTelemetry agent>>
