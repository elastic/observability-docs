...
APM Server tail-based sampling is recommended over OpenTelemetry tail-based sampling using the https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/processor/tailsamplingprocessor[tailsamplingprocessor] which has limitations described in <<open-telemetry-tbs,OpenTelemetry tail-based sampling limitations>>.
