...
CAUTION: This only prevents APM Server from capturing already ingested personal data.
It does not prevent this data from appearing in logs where applicable.
