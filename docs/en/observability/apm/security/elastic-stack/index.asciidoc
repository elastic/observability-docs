...
include::{observability-docs-root}/docs/en/observability/apm/security/elastic-stack/reader.asciidoc[leveloffset=+1]
include::{observability-docs-root}/docs/en/observability/apm/security/elastic-stack/annotation.asciidoc[leveloffset=+1]
include::{observability-docs-root}/docs/en/observability/apm/security/elastic-stack/api-ui.asciidoc[leveloffset=+1]
include::{observability-docs-root}/docs/en/observability/apm/security/elastic-stack/central-config.asciidoc[leveloffset=+1]
include::{observability-docs-root}/docs/en/observability/apm/security/elastic-stack/storage-explorer.asciidoc[leveloffset=+1]
