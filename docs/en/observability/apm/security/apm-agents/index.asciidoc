...
* <<apm-agent-tls,TLS encryption>> status_badge::[cloud_serverless, unavailable]
* <<apm-api-key,API key authentication>>
* <<apm-secret-token,Secret token authentication>> status_badge::[cloud_serverless, unavailable]
