...
[role="screenshot"]
image::./images/apm-transactions-overview.png[Example view of transactions table in the Applications UI in Kibana]
...
[role="screenshot"]
image::./images/apm-transactions-table.png[Example view of the transactions table in the Applications UI in Kibana]
