...
//QUESTION FOR COLLEEN or BRANDON: Can you confirm that service groups are enabled by default now? (I don't see the setting for enable service groups under advanced settings, so I have removed the section that describes how to do that.)
