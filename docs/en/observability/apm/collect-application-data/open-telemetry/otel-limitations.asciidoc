...
// TO DO: Also for the managed intake service?
* preview:[] The OpenTelemetry logs intake via {apm-server-or-mis} is in technical preview.
...
== OpenTelemetry's tail-based sampling status_badge::[cloud_serverless, unavailable]
