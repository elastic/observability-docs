...
Below are some common tasks that APM Server users might need to do and links to more information on creating roles that provides access to the right resources:
...
and you want to create an APM Server user who can <do something>, you would need to assign these three roles to the user:
...
subset of the privileges needed by users.
...
In these cases, another configured {es} role will need to be passed to
