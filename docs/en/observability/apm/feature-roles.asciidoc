...
If no built-in role is available, you can assign users the privileges needed to accomplish a specific task by
creating and assigning feature roles to users.
