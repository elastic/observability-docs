<<<<<<< HEAD:docs/en/observability/apm/feature-roles.asciidoc
...
[discrete]
== More resources
>>>>>>>> d6a61fd1 ([apm] Update APM feature roles docs (#4193)):docs/en/observability/apm/security/elastic-stack/index.asciidoc
...
*****
>>>>>>> d6a61fd1 ([apm] Update APM feature roles docs (#4193)):docs/en/observability/apm/security/elastic-stack/feature-roles.asciidoc
