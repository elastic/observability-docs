...
= Get started with APM on Elastic Cloud Serverless

// :description: Learn how to collect Application Performance Monitoring (APM) data and visualize it in real time.
// :keywords: serverless, observability, how-to

status_badge::[cloud_hosted, unavailable]

++++
<titleabbrev>Elastic Cloud Serverless</titleabbrev>
++++
...
++++
include::../collect-application-data/open-telemetry/index.asciidoc[tag=otel-get-started]
++++
  </div>
</div>
++++
...
refer to <<apm-collect-application-data>>.
...
Learn more about visualizing APM data in <<apm-view-and-analyze-data>>.

// TO DO: ADD SCREENSHOT

[TIP]
====
Not seeing any data? Find helpful tips in <<apm-troubleshoot-apm,Troubleshooting>>.
====
...
deeper level. Learn how to use <<apm-view-and-analyze-data,Elastic's built-in visualizations for APM data>>,
<<apm-alerts,alert on APM data>>,
or <<apm-collect-application-data,fine-tune how agents send traces to Elastic>>.
