...
////
TO DO:
Should I turn the whole section from the fleet guide into an include instead of just the tabbed widgets?
https://observability-docs_bk_4230.docs-preview.app.elstc.co/guide/en/observability/master/get-started-with-fleet-apm-server.html#_step_3_install_apm_agents
////
