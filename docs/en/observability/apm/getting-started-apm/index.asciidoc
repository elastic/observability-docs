...
There are three options, and the components required are different for each:

* **<<observability-apm-get-started,Elastic Cloud Serverless>>** status_badge::[cloud_hosted, unavailable]
* **<<apm-setup-fleet-managed-apm,Fleet-managed APM Server>>** status_badge::[cloud_serverless, unavailable]
* **<<apm-setup-apm-server-binary,APM Server binary>>** status_badge::[cloud_serverless, unavailable]

[float]
[[apm-setup-serverless-apm]]
== Elastic Cloud Serverless status_badge::[cloud_hosted, unavailable]

Serverless is...

++++
<div style="background-color:#F1F4FA;width:100%;height:200px"></div>
++++
...
== Fleet-managed APM Server status_badge::[cloud_serverless, unavailable]
...
== APM Server binary status_badge::[cloud_serverless, unavailable]
...
Subsections
////
include::{observability-docs-root}/docs/en/observability/apm/getting-started-apm/get-started-with-apm-serverless.asciidoc[leveloffset=+1]
include::{observability-docs-root}/docs/en/observability/apm/getting-started-apm/get-started-with-fleet-apm-server.asciidoc[leveloffset=+1]
include::{observability-docs-root}/docs/en/observability/apm/getting-started-apm/get-started-with-apm-server-binary.asciidoc[leveloffset=+1]
