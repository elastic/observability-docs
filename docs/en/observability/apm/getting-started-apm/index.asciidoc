...
* **<<observability-apm-get-started,Elastic Cloud Serverless>>** status_badge::[serverless, ga]
* **<<apm-setup-fleet-managed-apm,Fleet-managed APM Server>>** status_badge::[stack, ga]
* **<<apm-setup-apm-server-binary,APM Server binary>>** status_badge::[stack, ga]

[float]
[[apm-setup-serverless-apm]]
== Elastic Cloud Serverless status_badge::[serverless, ga]
...
== Fleet-managed APM Server status_badge::[stack, ga]
...
== APM Server binary status_badge::[stack, ga]
