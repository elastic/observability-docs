...
WARNING: Jaeger is deprecated and will be removed in a future version from Elastic APM, since OTEL has removed all Jaeger exporters from their https://github.com/open-telemetry/opentelemetry-specification/pull/2858[specification].
