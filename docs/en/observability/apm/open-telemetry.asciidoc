...
<<apm-open-telemetry-with-elastic,Get started>>.
...
<<apm-instrument-apps-otel,Get started>>.
...
<<apm-connect-open-telemetry-collector,Get started>>.
...
<<apm-open-telemetry-aws-lambda,Get started>>.
