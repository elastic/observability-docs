...
--
include::{observability-docs-root}/docs/en/observability/apm/getting-started-apm-server/_apm_server_binary.asciidoc[leveloffset=+2,tag=install-apm-integration-no-internet]
--
****
