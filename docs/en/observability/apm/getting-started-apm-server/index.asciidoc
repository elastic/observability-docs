...
////
:leveloffset: +1
include::{observability-docs-root}/docs/en/observability/apm/getting-started-apm-server/_apm_server_binary.asciidoc[]
include::{observability-docs-root}/docs/en/observability/apm/getting-started-apm-server/get-started-with-fleet-apm-server.asciidoc[]
:leveloffset!:
