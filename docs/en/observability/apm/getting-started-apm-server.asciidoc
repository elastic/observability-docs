...
See <<traces-get-started,Get started with application traces and APM>> to get started in minutes.
...
// Shared docker
include::shared-docker.asciidoc[]
...
include::../tab-widgets/add-apm-integration/content.asciidoc[tag=self-managed]

****
An internet connection is required to install the APM integration via the Fleet UI in Kibana.

--
include::getting-started-apm-server.asciidoc[tag=install-apm-integration-no-internet]
--
****
