////
TO DO:
Decide if custom links should also move to incident
management.
////
...
* *Custom links*: Build URLs that contain relevant metadata from a specific
  ...
  selected areas of the APM UI (for example, by transaction details). Read more in <<apm-custom-links,Custom links>>.
