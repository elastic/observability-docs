...
If you prefer to continue using ILM in 8.15 and later, follow the steps in this guide to create a custom ILM policy and add it to `@custom` component template.
====
