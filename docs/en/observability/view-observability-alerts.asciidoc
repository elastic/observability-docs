...
[role="screenshot"]
image::images/view-alert-details.png[View alert details flyout on the Alerts page]
...
. After you’ve completed all the required fields, click *Create case*. A notification message confirms you successfully
