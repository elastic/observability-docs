...
monitor is {heartbeat-ref}/configuration-ssl.html[configured to use SSL], {beatname_uc} establishes an
...
{heartbeat-ref}/configuration-ssl.html[configured to use SSL], {beatname_uc} establishes an
...
{heartbeat-ref}/configuration-ssl.html[configured to use SSL], it will attempt an SSL
