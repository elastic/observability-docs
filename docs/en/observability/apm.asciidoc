...
include::{observability-docs-root}/docs/en/observability/apm/getting-started-apm-server/index.asciidoc[leveloffset=+1]
...
include::{observability-docs-root}/docs/en/observability/apm/advanced-setup/index.asciidoc[leveloffset=+1]
...
include::{observability-docs-root}/docs/en/observability/apm/api-ui.asciidoc[]
...
include::{observability-docs-root}/docs/en/observability/apm/apm-app-users.asciidoc[]
include::{observability-docs-root}/docs/en/observability/apm/troubleshooting.asciidoc[]
