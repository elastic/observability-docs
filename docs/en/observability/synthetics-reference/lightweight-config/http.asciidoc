...
a| The total number of redirections Heartbeat will follow. By default, Heartbeat will not follow redirects, but will report the status of the redirect. If set to a number greater than `0`, Heartbeat will follow that number of redirects.
