...
// If no `locations` or `private_locations` are specified in the monitor configuration, but is defined in the <<synthetics-configuration,project configuration file>>, the monitors will be pushed to the locations listed in the project configuration file.

*Examples*:

[source,yaml]
----
locations: ["asia-northeast1-a", "asia-south1-a"]
----
