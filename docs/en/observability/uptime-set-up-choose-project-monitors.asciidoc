...
Learn how to configure <<synthetics-lightweight,lightweight monitors>> and <<synthetics-create-test,browser monitors>>. Then, read more about <<synthetics-projects-best-practices,best practices for working with Project Monitors>>.
