...
Click an SLO from the dashboard to get a more detailed view. Here you'll see the SLI history and the error budget burn down charts, as well as the current active alerts if any SLO burn rate alert rules have been set for the SLO.
