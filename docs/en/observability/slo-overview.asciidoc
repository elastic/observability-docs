...
For more information on automating the update process, see https://github.com/framsouza/es-slo-upgrade-helper/tree/main[framsouza/es-slo-upgrade-helper].

WARNING: Use the https://github.com/framsouza/es-slo-upgrade-helper/tree/main[framsouza/es-slo-upgrade-helper] at your own risk.
This tool is not officially maintained or supported by Elastic.
====
