...
+
image::images/monitor-gcp-navigate-logs-router.png[Navigate to Logs Router page]
+
...
+
image::images/monitor-gcp-create-pubsub-topic.png[Create Pub/Sub topic]
+
...
+
image::images/monitor-gcp-create-sink.png[Create logs routing sink]

. Now go to the *Pub/Sub* page to add a subscription to the topic you just
created. Use the search bar to find the page:
+
image::images/monitor-gcp-pub-sub.png[GCP Pub/Sub]
+
To add a subscription to the `monitor-gcp-audit` topic click
*Create subscription*:
+
image::images/monitor-gcp-pub-sub-create-subscription.png[Create GCP Pub/Sub Subscription]
+
Set `monitor-gcp-audit-sub` as the *Subscription ID* and leave the
*Delivery type* as pull:
+
image::images/monitor-gcp-pub-sub-subscription-id.png[GCP Pub/Sub Subscription ID]
+
