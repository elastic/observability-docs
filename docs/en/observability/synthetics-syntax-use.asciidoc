...
cd into the directory with your journey and test it with the `npx @elastic/synthetics` command.
For example:

[source,sh]
----
npx @elastic/synthetics short.js
----
...
[source,sh]
----
# Something goes here, but I can't get it to work yet
----
...
An example is provided in the `elastic/synthetics` repository.
