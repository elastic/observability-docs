...
querying {ref}/runtime.html[runtime fields]. Instead of entering an index pattern name,
click *Use {kib} index patterns* and select from a list of existing index patterns.
