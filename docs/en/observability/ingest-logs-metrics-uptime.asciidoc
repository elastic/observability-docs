...
In this step, you add the System integration to monitor host logs and metrics.

. Go to the {kib} home page and click **Add integrations**.
+
--
[role="screenshot"]
image::images/kibana-home.png[Kibana home page]
--
...
need to add a new row to the system log paths to read the log at
`/var/log/system.log`.
+
--
[role="screenshot"]
image::images/kibana-agent-add-log-path.png[Configuration page for adding log paths to the Elastic Agent System integration]
--
...
--
[role="screenshot"]
image::images/kibana-system-policy.png[Configuration page for adding the Elastic Agent System integration]
--
...
NOTE: To create a **browser** monitor, you must use the elastic-agent-complete Docker container as this contains the dependencies to run browser monitors. To learn more, refer to <<uptime-set-up>>.
