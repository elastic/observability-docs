...
= Overview
The Elastic Serverless Forwarder can forward {aws} data to cloud-hosted, self-managed Elastic environments or {ls} (Technology Preview). It supports the following inputs:
