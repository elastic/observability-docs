...
When data stops being reported, you can still control how alerts behave.
...
In the **If there is no data**, you can control how alerts behave when data stops being reported by selecting one of the following options:
