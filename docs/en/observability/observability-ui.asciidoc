...
The *Metrics* chart provides you with a glance at your top hosts with the most significant
resource footprint. The metrics help you evaluate the host efficiency and determine whether
there is any impact of resource consumption for your end-users.
...
outbound traffic metrics allow you to visualise any possible spikes to help determine whether
