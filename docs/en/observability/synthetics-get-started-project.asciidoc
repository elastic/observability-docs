...
.. Go to **Management** in the Synthetics UI.
.. Click **API Keys**.
...
Then, go to the Synthetics UI in {kib}. You should see your newly pushed monitors running. You can also go to the *Monitor Management* page to see the monitors' configuration settings.
