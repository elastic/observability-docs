...
+
[role="screenshot"]
image::images/monitor-azure-create-elastic-resource.png[Create Elastic resource]
+
[NOTE]
====
...
+
[role="screenshot"]
image::images/monitor-azure-elastic-deployment.png[Elastic resource]
...
+
[role="screenshot"]
image::images/monitor-azure-kibana-observability-page-empty.png[{kib} {observability}
page (no data)]
...
+
[role="screenshot"]
image::images/monitor-azure-elastic-click-ingest-logs.png[Click on Ingest logs and
metrics from Azure Services]

. Check both checkboxes and click *Save*.
+
[role="screenshot"]
image::images/monitor-azure-elastic-config-logs-metrics.png[Elastic configure logs and
metrics]
+
[NOTE]
====
...
+
[role="screenshot"]
image::images/monitor-azure-kibana-observability-page-data.png[{kib} {observability} page
(with data)]
...
+
[role="screenshot"]
image::images/monitor-azure-kibana-logs-app.png[{kib} {logs-app}]
...
+
[role="screenshot"]
image::images/monitor-azure-elastic-vms.png[Select VMs to collect logs and metrics from]
...
+
[role="screenshot"]
image::images/monitor-azure-kibana-vms-logs.png[VMs logs in the {logs-app}]
+
To see the VM metrics dashboard, click *Infrastructure*.
+
[role="screenshot"]
image::images/monitor-azure-kibana-vms-metrics.png[VMs metrics dashboard]
+
[NOTE]
====
...
+
image::images/monitor-azure-search-active-directory.png[Search and click on Azure
Active Directory]
+
. Click on *App registrations* in the navigation pane of the selected Active
Directory and then click on *New registration*.
+
image::images/monitor-azure-click-app-registration.png[Click on App registrations]
+
...
+
image::images/monitor-azure-register-app.png[Register an application]
+
...
+
image::images/monitor-azure-click-client-secret.png[Click on new client secret]
+
...
+
image::images/monitor-azure-search-subscriptions.png[Search and click on Subscriptions]
+
...
+
image::images/monitor-azure-add-role-assignment.png[Add role assignment]
+
...
+
[role="screenshot"]
image::images/monitor-azure-kibana-deployment.png[{ecloud} deployment]

. Click *Security* and then click *Reset password*. Confirm, and copy the
password. Keep it safe as you will use it later.
+
[role="screenshot"]
image::images/monitor-azure-kibana-security.png[{ecloud} security]
...
+
[role="screenshot"]
image::images/monitor-azure-billing-overview-dashboard.png[{metricbeat} azure billing
overview dashboard]
