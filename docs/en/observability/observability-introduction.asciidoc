...
== Real user monitoring (RUM) status_badge::[cloud_serverless, unavailable]
...
== Universal Profiling status_badge::[cloud_serverless, unavailable]
...
Applications UI. It provides a set of built-in actions and specific threshold rules
