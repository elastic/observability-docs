...
** *TLS certificate rule* for receiving notifications when one or more of your monitors has a
TLS certificate expiring within a specified threshold or when it exceeds an age limit.
