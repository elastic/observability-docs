...
and interactivity. Core Web Vitals are set to become the leading performance measurement in Google ranking factors, https://webmasters.googleblog.com/2020/11/timing-for-page-experience.html[beginning in May 2021].
