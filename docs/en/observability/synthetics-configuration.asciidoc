...
For information on configuring monitors individually, for browser monitors refer to <<synthetics-monitor-use>> and for lightweight monitors refer to <<synthetics-lightweight-data-types>>.
