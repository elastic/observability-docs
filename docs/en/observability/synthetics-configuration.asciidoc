...
+
By default, monitors are automatically retested if the monitor goes from an "up" to "down" condition.
If this retest is also "down", an error will be created, and if configured, an alert sent.
