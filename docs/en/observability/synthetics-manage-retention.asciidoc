...
Then, you can refer to https://www.elastic.co/guide/en/ingest-management/current/data-streams.html#data-streams-ilm-tutorial[Tutorial: Customize data retention for integrations] to learn how to apply a custom {ilm-init} policy to the browser data streams. 
