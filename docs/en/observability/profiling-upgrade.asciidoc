...
If you are upgrading from 8.8 we also provide a script that allows you to keep your data. When the product hits general availability,
...
. When upgrading from version 8.8.0 or better: Migrate existing profiling data
...
_This step is required for upgrades from versions before 8.8.0. For upgrades from 8.8.0 or better you can <<profiling-migrate-data,migrate your data>>._
