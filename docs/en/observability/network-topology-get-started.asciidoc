...
[role="screenshot"]
image::images/network-topology-site-overview.png[Network Topology site overview showing health cards for HQ-DC1, Branch-NYC, and Branch-CHI,75%]
...
[role="screenshot"]
image::images/network-topology-topology-map.png[Network Topology map view showing a force-directed graph of devices and links for the HQ-DC1 site,75%]
...
[role="screenshot"]
image::images/network-topology-device-flyout.png[Device flyout for hq-fw-01 showing interface table with status, speed, and traffic counters,75%]
...
[role="screenshot"]
image::images/network-topology-device-inventory.png[Network Topology Devices tab showing a paginated list of devices with status, hostname, IP, type, vendor, site, and interface counts,75%]
