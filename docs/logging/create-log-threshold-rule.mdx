...
Create a log threshold rule to trigger an alert when the log aggregation exceeds the specified threshold.
...
{/* TODO: Remove the following section? Is there something that needs to be said for serverless? */}
...
<Feedback slug="/serverless/observability/create-log-threshold-rule" filepath="docs/logging/create-log-threshold-rule.mdx" />
