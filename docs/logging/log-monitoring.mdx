...
- <DocLink id="serverlessObservabilityRunLogPatternAnalysis">Run pattern analysis on log data</DocLink>: Find patterns in unstructured log messages and makes it easier to examine your data.
