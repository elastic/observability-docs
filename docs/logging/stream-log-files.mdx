...
{/* import AgentLocationWidget from './transclusion/tab-widgets/logs/agent-location/widget.mdx' */}
{/* import StopWidget from '../fleet/transclusion/tab-widgets/stop-widget.mdx' */}
{/* import StartWidget from '../fleet/transclusion/tab-widgets/start-widget.mdx' */}
