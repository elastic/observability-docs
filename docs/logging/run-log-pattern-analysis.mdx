...
1. In the **Available fields** list, select the text field you want to analyze, then click **Run pattern analysis**.
    ...
    <DocImage size="m" url="../images/run-log-pattern-analysis.png" alt="Run log pattern analysis" />
...
**Log Explorer** only displays documents that match (or don't match) the selected patterns.
