...
1. In your ((observability)) project, go to **Log Explorer**.

1. Select a data view, for example **Kibana Sample Data Logs**, and apply any filters that you want.

1. If you don't see any results, expand the time range, for example, to **Last 15 days**.

1. In the **Available fields** list, select the field you want to analyze, then click **Run pattern analysis**.

    ![Run log pattern analysis ](../images/run-log-pattern-analysis.png)
...
**Discover** only displays documents that match (or don't match) the selected patterns.
