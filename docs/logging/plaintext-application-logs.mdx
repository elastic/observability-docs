...
To view logs ingested by ((filebeat)), go to <DocLink id="serverlessObservabilityDiscoverAndExploreLogs">Log Explorer</DocLink> from the main menu and click the **Open in Discover** link at the top of the Log Explorer page. Create a data view based on the `filebeat-*` index pattern. Refer to [Create a data view](((kibana-ref))/data-views.html) for more information.

To view logs ingested by ((agent)), go to <DocLink id="serverlessObservabilityDiscoverAndExploreLogs">Log Explorer</DocLink> from the main menu. Refer to the <DocLink id="serverlessObservabilityFilterAndAggregateLogs">Filter and aggregate logs</DocLink> documentation for more on viewing and filtering your log data.