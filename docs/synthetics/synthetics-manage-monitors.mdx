...
After you've <DocLink id="serverlessObservabilitySyntheticsGetStarted">created a synthetic monitor</DocLink>,
...
<DocCallOut title="Tip">
  ...
  <DocLink id="serverlessObservabilitySyntheticsManageMonitors" section="implement-best-practices-for-synthetics-projects">best practices for managing monitors effectively</DocLink>
...
After you've <DocLink id="serverlessObservabilitySyntheticsGetStartedProject">set up a Synthetics project</DocLink>,
