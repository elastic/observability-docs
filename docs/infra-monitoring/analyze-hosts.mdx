...
* <DocLink id="serverlessObservabilityAnalyzeHosts" section="dashed-interval">The chart interval is too short</DocLink>
* <DocLink id="serverlessObservabilityAnalyzeHosts" section="dashed-missing">Data is missing</DocLink>
* <DocLink id="serverlessObservabilityAnalyzeHosts" section="dashed-interval-and-missing">The chart interval is too short and data is missing</DocLink>
...
<div id="dashed-interval-and-missing"></div>
