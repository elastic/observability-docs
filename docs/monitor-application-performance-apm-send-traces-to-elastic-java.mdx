...
as well as a simple {/* <DocLink id="enApmAgentJavaPublicApi">API</DocLink> */} which allows you to instrument any application, and
a {/* <DocLink id="enApmAgentJavaPluginApi">Plugin API</DocLink> */} that allows you to add custom instrumentation.
...
More detailed information on how the Agent works can be found in the {/* <DocLink id="enApmAgentJavaFaq" section="how-does-the-agent-work?">FAQ</DocLink> */}.
