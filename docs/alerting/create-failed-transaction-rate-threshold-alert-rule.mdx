...
<Feedback slug="/serverless/observability/create-failed-transaction-rate-threshold-alert-rule" filepath="docs/alerting/create-failed-transaction-rate-threshold-alert-rule.mdx" />
