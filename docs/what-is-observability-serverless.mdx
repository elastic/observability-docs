...
<DocBadge><DocIcon size="s" type="image" title="missing image"/> missing image</DocBadge>
...
For more information, see <DocBadge><DocIcon size="s" type="unlink" title="missing link"/> missing link</DocBadge>{/*  <DocLink id="enObservabilityMonitorLogs">Log monitoring</DocLink> */}.
