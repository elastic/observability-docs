...
It has built-in support for {/* <DocLink id="enApmAgentRubyGettingStartedRails">Ruby on Rails</DocLink> */} and other
{/* <DocLink id="enApmAgentRubyGettingStartedRack">Rack-compatible</DocLink> */} applications.
